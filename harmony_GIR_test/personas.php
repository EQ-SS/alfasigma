...
<?php 
				if($tipoUsuario != 4){
?>
					<div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 align-right padding-0">
						...
						<button class="btn bg-red waves-effect btn-red" id="btnCargaDatosPersona" title="Carga Datos">
							Carga de datos
						</button>
					</div>
<?php
...
?>
					<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 align-center padding-0">
...
?>
				<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12 align-right padding-0" id="menuFiltrosGnr">
					<div class="display-inline display-screen-xs">
						...
						<button onClick="nuevaPagina(1,'<?= $hoy ?>','<?= $idsEnviar ?>','es' );"
							id="btnEnEsperaPersonas" class="btn waves-effect btn-account-head btn-account-c">
							En espera
						</button>
						<button onClick="nuevaPagina(1,'<?= $hoy ?>','<?= $idsEnviar ?>','fa' );"
							id="btnFallidaPersonas" class="btn waves-effect btn-account-head btn-account-c">
							Fallida
						</button>
				...
				<div class="col-lg-1 col-md-1 col-sm-2 col-xs-2 align-right padding-0">
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2">
											<div class="form-group">
												<div class="input-group">
													...
													<input id="txtApellidoPaternoFiltro" type="text" class="form-control"
														name="aPaternoFiltros" placeholder="Apellido Paterno">
												</div>
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2">
											<div class="form-group">
												<div class="input-group">
													<span class="input-group-addon"><i
															class="glyphicon glyphicon-user"></i></span>
													<input id="txtApellidoMaternoFiltro" type="text" class="form-control"
														name="aMaternoFiltros" placeholder="Apellido Materno">
												</div>
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2">
...
?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2">
											<div class="form-group" style="display:inline-flex;">
												<!--<label class="m-r-5 p-t-5">Sub especialidad: </label>-->
												<select id="sltSubEspecialidadFiltro" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000">
														Sub Especialidad
													</option>
													<?php
													$rsEsp = llenaCombo($conn, 19, 51);
													while($esp = sqlsrv_fetch_array($rsEsp)){
														echo '<option value="'.$esp['id'].'">'.$esp['nombre'].'</option>';
													}
?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2">
											<div class="form-group">
												<select id="sltPacientesXSemanaFiltro" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000">
														Pacientes X Semana
													</option>
<?php
													$rsEsp = llenaCombo($conn, 19, 389);
													while($esp = sqlsrv_fetch_array($rsEsp)){
														echo '<option value="'.$esp['id'].'">'.$esp['nombre'].'</option>';
													}
?>
												...
												<!--<div class="input-group">
													<span class="input-group-addon"><i
															class="glyphicon glyphicon-user"></i></span>
													<input id="txtPacientesXdiaFiltros" type="text" class="form-control"
														name="pacientesXdiaFiltros" placeholder="Pacientes X Día">
												</div>-->
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2">
											<div class="form-group">
												<select id="sltHonorariosFiltro" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000">
														Honorarios
													</option>
<?php
...
?>
												...
												<!--<div class="input-group">
													<span class="input-group-addon"><i
															class="glyphicon glyphicon-user"></i></span>
													<input id="txtHonorariosFiltro" type="text" class="form-control"
														name="honorariosFiltros" placeholder="Honorarios">
												</div>-->
											</div>
										</div>
									</div>
...
?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2" hidden>
											<div class="form-group">
												<select class="form-control" id="sltDificultadVisitaFiltro">
													<option value="00000000-0000-0000-0000-000000000000">
														Dificultad de la visita</option>
					<?php
...
?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2" hidden>
											<div class="form-group">
												...
												<select class="form-control" id="sltCategoriaAuditFiltro">
													<option value="00000000-0000-0000-0000-000000000000">
														Categoría Audit</option>
													<?php
											$rsSiNo = llenaCombo($conn, 19, 508);
				...
				?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2">
											<div class="form-group">
												...
												<select id="sltTipoInstFiltroPersonas" class="form-control" name="tipoInstFiltroPersonas">
													<option value="00000000-0000-0000-0000-000000000000">
														Tipo
													</option>
<?php
...
?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2">
											<div class="form-group">
												<!--<label>Subtipo *</label>-->
												<select id="sltSubtipoInstFiltro" class="form-control" name="subTipoInstFiltro">
											...
											<div class="form-group">
												<div class="input-group">
													...
													<input id="txtDireccionFiltro" type="text" class="form-control"
														name="calleFiltro" placeholder="Calle/Dirección">
												</div>
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2">
											<div class="form-group">
												<div class="input-group">
													<span class="input-group-addon"><i
															class="glyphicon glyphicon-map-marker"></i></span>
													<input id="txtNumExtFiltro" type="text" class="form-control"
														name="numExtFiltro" placeholder="Número Exterior">
												</div>
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2">
											<div class="form-group">
												<div class="input-group">
													...
													<input id="txtCPFiltro" type="text" class="form-control"
														name="estado" placeholder="Código Postal">
												</div>
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2">
									...
									<div class="row">
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2">
											<div style="display:inline-flex;">
												<input name="rbGeoFiltroPersonas" type="radio" id="rbtTodosFiltroPersonas"
													class="with-gap radio-col-indigo" value="todo"/>
												<label for="rbtTodosFiltroPersonas">Todos</label>
												<input name="rbGeoFiltroPersonas" type="radio" id="rbtGeoSiFiltroPersonas"
													class="with-gap radio-col-indigo"  value="si" />
												<label for="rbtGeoSiFiltroPersonas">Geoloc.</label>
												<input name="rbGeoFiltroPersonas" type="radio" id="rbtGeoNoFiltroPersonas"
													class="with-gap radio-col-indigo"  value="no" />
												<label for="rbtGeoNoFiltroPersonas">No Geoloc.</label>
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-margin2">
											<?php
			...
			<div class="right-sidebar-person">
				<div style="display: inline-grid;">
					<ul id="rightSideBarPerson" class="no-style-list">
						...
						<li data-toggle="tooltip" data-placement="left" title="Inversiones">
							<a href="#tabs-10">
								<button id="tabMed10" type="button" onClick="cambiaTab(this.id);" 
									class="btn btn-default waves-effect add-margin-bottom p-l-10 p-r-10 btn-indigo2">
