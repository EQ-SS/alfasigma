...
$('#divRespuesta').load("ajax/CargarLineas.php",{sltLinea:sltLinea,idUsuario:idUsuario,tipoUsuario:tipoUsuario,sltEstado:sltEstado,sltCobDiaAnterior:sltCobDiaAnterior,sltCobDiaria:sltCobDiaria,sltCobCiclo:sltCobCiclo,sltRepre:sltRepre});
			...
			$('#btnRefresh').click(function(){
				...
				$('#btnHistorialVisitasLocalizadorRepres').click(function(){
					var repre = $('#sltRepreRadar').val();
						var sltDiaAnterior=$('#sltCobDiaAnterior').val();
				$('#divRespuesta').load("ajax/marcadoresHistorialVisitas.php",{idUsuario:repre,sltDiaAnterior:sltDiaAnterior});
			...
			$("#btnGuardarPersonaNuevo").click(function () {
				...
				if ($("#formAgregarPersona").valid()) {
					...
					speaker = $('#sltSpeakerPersonaNuevo').val();
					...
					$("#divRespuesta").load("ajax/guardarPersona.php", {
						...
						aceptaApoyo: aceptaApoyo,
						porqueAceptaApoyo: porqueAceptaApoyo,
						botiquin: botiquin,
			...
			*/
			...
			$("#btnGuardarInstNueva").click(function () {
				...
				if ($("#formAgregarInst").valid()) {
					...
					for(i=0;i<= $("#contadorChecksTipoPaciente").val(); i++){
						if($("#tipoPaciente" + i).prop('checked')){
							field02InstNueva_snr += $('#tipoPaciente'+i).val() + ";";
						}
					}
					...
					for(i=0;i<= $("#contadorChecksField06").val(); i++){
					...
					for(i=0;i<= $("#contadorChecksField07").val(); i++){
					...
					for(i=0;i<= $("#contadorChecksField09").val(); i++){
					...
					for(i=0;i<= $("#hdnTotalChecksTipoPaciente").val(); i++){
						if($("#tipoPaciente" + i).prop('checked')){
							field01InstNuevaHosp_snr += $('#tipoPaciente'+i).val() + ";";
						}
					}
		...
		function eliminarPersona(idPersona, nombre, cargo, datosMedico, ruta){
			...
			//alert(tipoUsuario);
			if(tipoUsuario == 4){
				$('#divRespuesta').load("ajax/limiteEliminarMedico.php",{idUsuario:idUsuario,idPersona:idPersona,nombre:nombre,cargo:cargo,datosMedico:datosMedico});
				//$('body').addClass('no-scroll');
			}else{
...
?>
					<li id="imgGeoRepres" class="hover2">
						<a>
							...
							<span class="font-17">Mapa de Calor</span>
						</a>
					</li>
