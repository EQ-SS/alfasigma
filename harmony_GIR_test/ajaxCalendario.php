	...
	echo "<script>
		...
		if(! empty($arrHoy[0])){
			for($i=0;$i<count($arrHoyReg);$i++){
				...
				if(count($arrTr) == 3){
					$nombre = str_replace("'", "", $arrTr[2]);
					if($arrTr[0] == ''){//otras actividades
						echo "$('#tblHoy').append('<tr><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}else{
						echo "$('#tblHoy').append('<tr onClick=\"".str_replace("'", "\'", $arrTr[0])."\"><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}
				}
			}
		}
		...
		if(! empty($arrLunes[0])){
			for($i=0;$i<count($arrLunesReg);$i++){
				...
				if(count($arrTr) == 3){
					$nombre = str_replace("'", "", $arrTr[2]);
					if($arrTr[0] == ''){//otras actividades
						echo "$('#tblDiaUno').append('<tr><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}else{
						echo "$('#tblDiaUno').append('<tr onClick=\"".str_replace("'", "\'", $arrTr[0])."\"><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}
				}
			}
		}
		...
		if(! empty($arrMartes[0])){
			for($i=0;$i<count($arrMartesReg);$i++){
				...
				if(count($arrTr) == 3){
					$nombre = str_replace("'", "", $arrTr[2]);
					if($arrTr[0] == ''){//otras actividades
						echo "$('#tblDiaDos').append('<tr><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}else{
						echo "$('#tblDiaDos').append('<tr onClick=\"".str_replace("'", "\'", $arrTr[0])."\"><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}
				}
			}
		}
		...
		if(! empty($arrMiercoles[0])){
			for($i=0;$i<count($arrMiercolesReg);$i++){
				...
				if(count($arrTr) == 3){
					$nombre = str_replace("'", "", $arrTr[2]);
					if($arrTr[0] == ''){//otras actividades
						echo "$('#tblDiaTres').append('<tr><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}else{
						echo "$('#tblDiaTres').append('<tr onClick=\"".str_replace("'", "\'", $arrTr[0])."\"><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}
				}
			}
		}
		...
		if(! empty($arrJueves[0])){
			for($i=0;$i<count($arrJuevesReg);$i++){
				...
				if(count($arrTr) == 3){
					$nombre = str_replace("'", "", $arrTr[2]);
					if($arrTr[0] == ''){//otras actividades
						echo "$('#tblDiaCuatro').append('<tr><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}else{
						echo "$('#tblDiaCuatro').append('<tr onClick=\"".str_replace("'", "\'", $arrTr[0])."\"><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}
				}
			}
		}
		...
		if(! empty($arrViernes[0])){
			for($i=0;$i<count($arrViernesReg);$i++){
				...
				if(count($arrTr) == 3){
					$nombre = str_replace("'", "", $arrTr[2]);
					if($arrTr[0] == ''){//otras actividades
						echo "$('#tblDiaCinco').append('<tr><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}else{
						echo "$('#tblDiaCinco').append('<tr onClick=\"".str_replace("'", "\'", $arrTr[0])."\"><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}
				}
			}
		}
		...
		if(! empty($arrSabado[0])){
			for($i=0;$i<count($arrSabadoReg);$i++){
				...
				if(count($arrTr) == 3){
					$nombre = str_replace("'", "", $arrTr[2]);
					if($arrTr[0] == ''){//otras actividades
						echo "$('#tblDiaSeis').append('<tr><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}else{
						echo "$('#tblDiaSeis').append('<tr onClick=\"".str_replace("'", "\'", $arrTr[0])."\"><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}
				}
			}
		}
		...
		if(! empty($arrDomingo[0])){
			for($i=0;$i<count($arrDomingoReg);$i++){
				...
				if(count($arrTr) == 3){
					$nombre = str_replace("'", "", $arrTr[2]);
					if($arrTr[0] == ''){//otras actividades
						echo "$('#tblDiaSiete').append('<tr><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}else{
						echo "$('#tblDiaSiete').append('<tr onClick=\"".str_replace("'", "\'", $arrTr[0])."\"><td style=\"".$arrTr[1]."\">".$nombre."</td></tr>');";
					}
				}
			}
		}
