				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 m-t-15">
					<div class="form-group margin-0">
						<div class="input-group">
							<input id="txtBuscarPersona" type="text" size="100" class="form-control"
								placeholder="Buscar médico por nombre...">
							<span class="input-group-addon padding-0">
								<button id="btnBuscarMed" class="btn waves-effect btn-indigo2" style="padding: 3px 12px;">
						...
						<select id="sltRutaBuscaPersonas" class="form-control">
							...
							<?php
								...
								while($regUser = sqlsrv_fetch_array($rsUsers)){
									echo '<option value="'.$regUser['USER_SNR'].'">'.$regUser['USER_NR'].' - '.$regUser['LNAME'].' '.$regUser['MOTHERS_LNAME'].' '.$regUser['FNAME'].'</option>';
								}
?>
						</select>
					</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="new-div">
						<div class="div-tbl-aprob-pers">
							<table class="table-striped table-hover cargaBusquedaMed" id="tblBuscarPersonas">
								<thead class="bg-cyan">
									<tr>
										<?php
						if($tipoUsuario != 4){
							echo '<td width="10%">Ruta</td>
...
?>
						...
						<div id="totalMedicosBuscados" class="font-bold"></div>
					</div>
				</div>
			</div>
		</div>
