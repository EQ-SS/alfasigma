		...
		<div class="card m-b--15 card-add-new">
			<div class="header row padding-0">
				...
				<div class="col-lg-6 col-md-6 col-sm-10 col-xs-11 align-center m-t-10 m-b-10 display-inline">
					...
					<button id="btnVisitaEnEsperaInst" type="button" class="btn bg-indigo waves-effect btn-indigo m-l-10">
						Visita en Espera
					</button>
...
?>
													...
													<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
														<div class="form-group margin-0">
															...
															<select id="lstMotivoNoVisitaInst" class="form-control">
																<option value="00000000-0000-0000-0000-000000000000">Seleccione</option>
<?php
																$rsCodigo = llenaCombo($conn, 34, 12);
																while($codigo = sqlsrv_fetch_array($rsCodigo)){
																	echo '<option value="'.$codigo['id'].'" >'.utf8_encode($codigo['nombre']).'</option>';
																}
?>
															...
															<div class="multiselect">
																<div class="selectBox"
																	...
																	<select class="form-control">
																		<option id="sltMultiSelectInstVisita">Selecciona
																		</option>
																	</select>
...
?>
															...
															<input type="hidden" id="hdnTotalChecksInst"
																value="<?= $contadorChecks ?>">
															<input type="hidden" id="hdnDescripcionChkVisitasInst"
																value="<?= ($descripcionesCheck == '') ? "
															 Seleccione" : $descripcionesCheck ?>" />
														</form>
							...
							<div id="tabs-3">
								...
								<div class="pull-center">
									...
									<img id="imgFirmaInst" width="400" height="400" />
							...
							<div id="stock">
								<table width="100%" border="0" id="tblContenedorStock">
											...
											<table id="tblProductoSeleccionado"
												...
												<thead class="bg-grey">
													<tr>
														...
														<td width="15%">Desplazamiento</td>
														<td width="15%">Existencia</td>
														<td width="15%">Precio</td>
														<!--<td width="10%">Cadena</td>
														<td width="10%">Promociones</td>
									...
									<tr>
										<td colspan="2" height="150px">
											<table border="0" width="100%" id="tblProductosSeleccionados"
												class="table table-striped grid_scroll_body">
												<thead class="bg-grey">
													<tr>
														...
														<!--<td width="10%">Cadena</td>
														<td width="10%">Promociones</td>-->
														<td width="15%" align="right">Eliminar</td>
													</tr>
												</thead>
												<tbody height="140px">
												</tbody>
								...
								<table width="100%" id="tblProductosStockConsulta" 
									class="table table-striped grid_scroll_body" style="display:none;">
									<thead class="bg-grey">
										<tr>
											<td width="40%">Producto</td>
											<td width="10%">Inventario</td>
											<td width="10%">Agotado</td>
											<td width="10%">Sugerido</td>
											<td width="15%">Cadena</td>
											<td width="15%">Promociones</td>
										</tr>
									</thead>
									<tbody height="340px" width="100%">
									</tbody>
								</table>
							</div>
						</div>
