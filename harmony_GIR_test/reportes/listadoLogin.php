...
<?php
	...
	cast(convert(date, UL.start_action_time, 20) as nvarchar(10)) as Fecha_Login,
	convert(char(5), UL.start_action_time, 108) as Hora_Login
	
	from USER_LOGGING UL
	inner join Users as U on U.user_snr = UL.user_snr 
	...
	/*and convert(date,UL.start_action_time,101) between '2023-08-01' and '2023-08-30' */
	
	group by cl.name,Ugte.user_nr,U.user_nr,U.lname,U.fname,UL.start_action_time
