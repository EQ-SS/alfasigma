...
<?php
	...
	$nombreListado="Listado_Farmacias";
	...
	cast(cast(I.changed_timestamp as DATE) as varchar(10)) as Fecha_Mod,
	...
	/*left outer join inst_pharmacy IUD on I.inst_snr = IUD.inst_snr
	left outer join codelist PERFIL1 on IUD.field_01_snr = PERFIL1.clist_snr */
	...
	$qMedicos .= " order by U.user_nr,U.lname,U.fname,I.name,I.street1 ";
