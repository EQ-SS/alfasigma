...
<?php
	...
	$nombreListado="Listado_Inversiones";
	...
	INV.name as Concepto,
	TINV.name as Tipo_Inversion,
	PINV.name as Producto,
	cast(cast(INV.DATE as DATE) as varchar(10)) as Fecha_Inversion,
	INV.amount_invested as Cantidad_Invertida,
	INV.info as Comentarios 
	...
	inner join user_investment INV on INV.pers_snr = P.pers_snr 
	left outer join codelist TINV on cast(TINV.clist_snr as varchar(36)) = INV.type_snr 
	left outer join product PINV on cast(PINV.prod_snr as varchar(36)) = cast(substring(INV.prod_snr,1,36) as varchar(36)) 
	...
	order by U.user_nr,U.lname,U.fname,P.lname,P.mothers_lname,P.fname ";
