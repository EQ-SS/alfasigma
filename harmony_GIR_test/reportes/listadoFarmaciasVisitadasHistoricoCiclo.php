<?php
	...
	if($estatus != ''){
		$qMedicos .= "and I.status_snr in ('".$estatus."') ";
	}
	
	$qMedicos .= "order by U.user_nr,U.lname,I.name,I.street1 ";
	...
	$reemplazar=array(" ", " ", " ", " ");
	$tam = array(100,100,100,300,350,200,250,350,350,150, 250,100,200,200,150,100,100,100,100,100, 100,100,100,100,100,100,100,100,100,100, 100,100,100,100,100,100,100,100,100,100, 100,100,100,100,100,100,100,100,100,100, 100,100,100,100,100,100,100,100,100, 100,100,100,100,100,100);
	...
	echo "<script>
		$('#btnExportaHistorico').click(function(){
			...
			$(form).attr('action', 'ajax/listadoExcelHistoricoFarm.php');
