...
echo "<script>
	...
	if($contador == 0){
		...
		//echo "$('#tblListFrecCategoria tbody').append('<tr><td style=\"width:100%;\">".str_replace("'", "\'", $queryFreCat)."</td></tr>');";
	}else{
        echo "$('#tblListFrecCategoria tbody').append('".$result."');";
		//echo "$('#tblListFrecCategoria tbody').append('".str_replace("'", "\'", $queryFreCat)."');";
    }
