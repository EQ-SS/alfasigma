			...
			while($inst = sqlsrv_fetch_array($rsInst)){
				...
				if($fecha == ''){
					if($tipoUsuario == 4){
						...
						echo "$('#tblBuscarInst tbody').append('<tr onClick=\"instSeleccionada(\'".$inst['inst_snr']."\');\"><td style=\"width:8%;\">".$inst['ruta']."</td><td style=\"width:11%;\">".$inst['tipo']."</td><td style=\"width:15%;\">".$inst['nombre']."</td><td style=\"width:15%;\">".$inst['calle']."</td><td style=\"width:15%;\">".$inst['colonia']."</td><td style=\"width:8%;\">".$inst['cp']."</td><td style=\"width:15%;\">".$inst['delegacion']."</td><td style=\"width:13%;\">".$inst['estado']."</td></tr>');";
					}
				}else{
					if($tipoUsuario == 4){
						...
						echo "$('#tblBuscarInst tbody').append('<tr onClick=\"nuevoPlanInst(\'".$inst['inst_snr']."\',\'".$fecha."\',\'".$inst['user_snr']."\');\"><td style=\"width:8%;\">".$inst['ruta']."</td><td style=\"width:11%;\">".$inst['tipo']."</td><td style=\"width:15%;\">".$inst['nombre']."</td><td style=\"width:15%;\">".$inst['calle']."</td><td style=\"width:15%;\">".$inst['colonia']."</td><td style=\"width:8%;\">".$inst['cp']."</td><td style=\"width:15%;\">".$inst['delegacion']."</td><td style=\"width:13%;\">".$inst['estado']."</td></tr>');";
					}
				}
			}
			echo "</script>";
