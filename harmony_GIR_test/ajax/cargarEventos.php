<?php
	...
	if(! $conn){
		...
		if(obtenerTipo($conn, $idUsuario) == 4){
			$queryTabla .= "and e.USER_SNR = '".$idUsuario."' ";
		}
		$queryTabla .= "order by e.start_date desc";
		//echo $queryTabla."<br>";
