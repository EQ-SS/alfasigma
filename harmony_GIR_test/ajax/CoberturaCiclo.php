<?php
	...
	$arrDiaDeCiclo = sqlsrv_fetch_array(sqlsrv_query($conn,"SELECT CYCLE_DETAILS.C_DAY FROM CYCLE_DETAILS WHERE CYCLE_SNR IN (SELECT CYCLE_SNR FROM CYCLES WHERE  '".date("Y-m-d")."' BETWEEN START_DATE AND FINISH_DATE) AND CAST(GETDATE() AS DATE)=CYCLE_DETAILS.C_DATE "));
	...
	(LINEA.DAILY_CONTACTS * ".$diaDelCiclo.") * COUNT(DISTINCT VP.USER_SNR) AS CONTACTOS,
	ISNULL(COUNT(DISTINCT DR.USER_SNR),0) as TFT,
	COUNT(DISTINCT DR.USER_SNR) *  ".$diaDelCiclo."  CONTACTOS_TFT
	FROM PERSON P 
	INNER JOIN CYCLES CYC ON CYC.REC_STAT=0 AND GETDATE() BETWEEN CYC.START_DATE AND CYC.FINISH_DATE
	...
	LEFT OUTER JOIN VISITPERS VP ON P.PERS_SNR=VP.PERS_SNR AND VP.REC_STAT=0 AND VP.VISIT_DATE BETWEEN CYC.START_DATE AND CYC.FINISH_DATE
	LEFT OUTER JOIN VISITPERS VPP ON P.PERS_SNR=VPP.PERS_SNR AND VPP.REC_STAT=0 AND VPP.VISIT_DATE BETWEEN CYC.START_DATE AND CYC.FINISH_DATE AND VPP.VISIT_CODE_SNR in ('2B3A7099-AC7D-47A3-A274-F0B029791801','E9A14663-1F3E-4707-915B-1891CC34AD1B') 
	LEFT OUTER JOIN VISITPERS VPV ON P.PERS_SNR=VPV.PERS_SNR AND VPV.REC_STAT=0 AND VPV.VISIT_DATE BETWEEN CYC.START_DATE AND CYC.FINISH_DATE AND VPV.VISIT_CODE_SNR in ('5655BC78-6002-4097-82CC-8BA7E1FBD5FC') 
	LEFT OUTER JOIN DAY_REPORT DR ON DR.USER_SNR=U.USER_SNR AND DR.REC_STAT=0 AND DR.START_DATE BETWEEN CYC.START_DATE AND CYC.FINISH_DATE";
		...
		while($dataTabla = sqlsrv_fetch_array($rsTabla)){
			...
			$por=$dataTabla[5];
			  ...
			  if($por<50){
			 	...
			 	if($por<1){
			 		echo "<script>$('#tblLocRep tbody').append('<tr style=\"background-color: #ff5232;color:white;\" ><td>".$dataTabla[1]."</td><td>".$dataTabla[0]."</td><td>".$formato_vis_presT."</td><td>".$formato_vis_pres."</td><td>".$formato_vis_vi."</td><td>"."0".$dataTabla[5]."%"."</td><td>".$dataTabla[6]."</td></tr>');</script>";
			 	}else{
			 		echo "<script>$('#tblLocRep tbody').append('<tr style=\"background-color: #ff5232;color:white;\" ><td>".$dataTabla[1]."</td><td>".$dataTabla[0]."</td><td>".$formato_vis_presT."</td><td>".$formato_vis_pres."</td><td>".$formato_vis_vi."</td><td>".$dataTabla[5]."%"."</td><td>".$dataTabla[6]."</td></tr>');</script>";
			 	}
			...
			if($por > 50 && $por < 78){
				...
				if($por<1){
					echo "<script>$('#tblLocRep tbody').append('<tr style=\"background-color: #ffa040;color:black;\" ><td>".$dataTabla[0]."</td><td>".$dataTabla[1]."</td><td>".$formato_vis_presT."</td><td>".$formato_vis_pres."</td><td>".$formato_vis_vi."</td><td>"."0".$dataTabla[5]."%"."</td><td>".$dataTabla[6]."</td></tr>');</script>";
				}else{
					echo "<script>$('#tblLocRep tbody').append('<tr style=\"background-color: #ffa040;color:black;\" ><td>".$dataTabla[0]."</td><td>".$dataTabla[1]."</td><td>".$formato_vis_presT."</td><td>".$formato_vis_pres."</td><td>".$formato_vis_vi."</td><td>".$dataTabla[5]."%"."</td><td>".$dataTabla[6]."</td></tr>');</script>";
				}
			...
			if($por >=78 && $por <= 94 ){
				...
				if($por<1){
					echo "<script>$('#tblLocRep tbody').append('<tr style=\"background-color:  #ffff90;color:black;\" ><td>".$dataTabla[1]."</td><td>".$dataTabla[0]."</td><td>".$formato_vis_presT."</td><td>".$formato_vis_pres."</td><td>".$formato_vis_vi."</td><td>"."0".$dataTabla[5]."%"."</td><td>".$dataTabla[6]."</td></tr>');</script>";
				}else{
					echo "<script>$('#tblLocRep tbody').append('<tr style=\"background-color:  #ffff90;color:black;\" ><td>".$dataTabla[1]."</td><td>".$dataTabla[0]."</td><td>".$formato_vis_presT."</td><td>".$formato_vis_pres."</td><td>".$formato_vis_vi."</td><td>".$dataTabla[5]."%"."</td><td>".$dataTabla[6]."</td></tr>');</script>";
				}
			...
			if($por >= 95 ){
				...
				if($por<1){
					echo "<script>$('#tblLocRep tbody').append('<tr style=\"background-color: #84e283;color:black;\" ><td>".$dataTabla[1]."</td><td>".$dataTabla[0]."</td><td>".$formato_vis_presT."</td><td>".$formato_vis_pres."</td><td>".$formato_vis_vi."</td><td>"."0".$dataTabla[5]."%"."</td><td>".$dataTabla[6]."</td></tr>');</script>";
				}else{
					echo "<script>$('#tblLocRep tbody').append('<tr style=\"background-color: #84e283;color:black;\" ><td>".$dataTabla[1]."</td><td>".$dataTabla[0]."</td><td>".$formato_vis_presT."</td><td>".$formato_vis_pres."</td><td>".$formato_vis_vi."</td><td>".$dataTabla[5]."%"."</td><td>".$dataTabla[6]."</td></tr>');</script>";
				}
