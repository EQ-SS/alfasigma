...
$consCategorias = array('1', '2', '3', '4', '5', 'NC');
...
$queryGrafica1 = "with chart3 as (
	...
	while($regGrafica1 = sqlsrv_fetch_array($rsGrafica1)){
		...
		switch ($regGrafica1['categ']){
			...
			case "C":
				...
				break;
			case "D":
				$arrVNV['D']['V'] += $regGrafica1['visit'];
				$arrVNV['D']['N'] += $regGrafica1['novis'];
				break;
			case "SC":
	...
	$nombres = '{"label": "A"},{"label": "B"},{"label": "C"},{"label": "D"},{"label": "SC"}';
	$valores_Frec_A = '{"value": "'.$arrCategorias['A']['A'].'"},{"value": "'.$arrCategorias['B']['A'].'"},{"value": "'.$arrCategorias['C']['A'].'"},{"value": "'.$arrCategorias['D']['A'].'"},{"value": "'.$arrCategorias['SC']['A'].'"}';
	$valores_Frec_B = '{"value": "'.$arrCategorias['A']['B'].'"},{"value": "'.$arrCategorias['B']['B'].'"},{"value": "'.$arrCategorias['C']['B'].'"},{"value": "'.$arrCategorias['D']['B'].'"},{"value": "'.$arrCategorias['SC']['B'].'"}';
	$valores_Frec_C = '{"value": "'.$arrCategorias['A']['C'].'"},{"value": "'.$arrCategorias['B']['C'].'"},{"value": "'.$arrCategorias['C']['C'].'"},{"value": "'.$arrCategorias['D']['C'].'"},{"value": "'.$arrCategorias['SC']['C'].'"}';
	$valores_Frec_D = '{"value": "'.$arrCategorias['A']['D'].'"},{"value": "'.$arrCategorias['B']['D'].'"},{"value": "'.$arrCategorias['C']['D'].'"},{"value": "'.$arrCategorias['D']['D'].'"},{"value": "'.$arrCategorias['SC']['D'].'"}';
