<?php
	...
	if(! $conn){
		...
		if($idPlan == ''){
			...
			//echo $idRepre." ::: ".$idUser."<br>";
			//echo "select * from visinstplan where plan_date = '$fechaPlan' and inst_snr = '$idInst' and user_snr = '$idUsuario'<br>";
			$rsExiste = sqlsrv_query($conn, "select * from visinstplan where plan_date = '$fechaPlan' and inst_snr = '$idInst' and user_snr = '$idUsuario'", array(), array( "Scrollable" => SQLSRV_CURSOR_KEYSET ));
