<?php
	...
	$queryGrafica5 = "select 999 as sort_num, 
		...
		$datos = '';
		$datos2 = '';
		$registrados = $visitados  = array();
		$especialidad = array('GINEC OBSTET','MED-GEN','ORTO-TRAUM','PEDIAT','OTRAS');
		$totalOtras = 0;
		while($regGrafica5 = sqlsrv_fetch_array($rsGrafica5)){	
			switch ($regGrafica5['ESP']){
				case 'GINEC OBSTET':
					$datos .= '{"label": "'.$regGrafica5['ESP'].'","value": "'.$regGrafica5['regist'].'"},';
					$registrados[0] = $regGrafica5['regist'];
					$visitados[0] = $regGrafica5['VISITADOS'];
					break;
				case 'MED-GEN':
					$datos .= '{"label": "'.$regGrafica5['ESP'].'","value": "'.$regGrafica5['regist'].'"},';
					$registrados[1] = $regGrafica5['regist'];
					$visitados[1] = $regGrafica5['VISITADOS'];
					break;
				case 'ORTO-TRAUM':
					$datos .= '{"label": "'.$regGrafica5['ESP'].'","value": "'.$regGrafica5['regist'].'"},';
					$registrados[2] = $regGrafica5['regist'];
					$visitados[2] = $regGrafica5['VISITADOS'];
					break;
				case 'PEDIAT':
					$datos .= '{"label": "'.$regGrafica5['ESP'].'","value": "'.$regGrafica5['regist'].'"},';
					$registrados[3] = $regGrafica5['regist'];
					$visitados[3] = $regGrafica5['VISITADOS'];
					break;
				default:
					$totalOtras += $regGrafica5['regist'];
					$totalOtrasVisitados += $regGrafica5['VISITADOS'];
			}
		...
		$datos .= '{"label": "Otras","value": "'.$totalOtras.'"},';
		$datos = substr($datos, 0, -1);
		
		$registrados[4] = $totalOtras;
		$visitados[4] = $totalOtrasVisitados;
