function agregarPersona() {
    $("#formAgregarPersona").validate({ // initialize plugin on the form
        rules: {
			...
			pacientesXSemanaPersonaNuevo: {
                fielSelected: true
            },
            honorariosPersonaNuevo: {
                fielSelected: true
            },
            cedulaP: {
                //required: true,
           ...
           email1PerfilP: {
			...
			compraDirectaPersonaNuevo: {
				fielSelected: true
            },
			liderOpinionPersonaNuevo: {
				fielSelected: true
            },
			botiquinPersonaNuevo: {
				fielSelected: true
            },
			tipoConsultaPersonaNuevo: {
				fielSelected: true
            }*/
        },
        ...
        messages: {
            ...
            pacientesXSemanaPersonaNuevo: "Seleccione los pacientes por semana",
            honorariosPersonaNuevo: "Seleccione los honorarios",
			...
			compraDirectaPersonaNuevo: "Seleccione la compra directa",
			liderOpinionPersonaNuevo: "Seleccione el líder de opinión",
			botiquinPersonaNuevo: "Seleccione el médico de botiquín",
			tipoConsultaPersonaNuevo: "Seleccione el tipo de consulta"
        },
...
function agregarInstitucion() {
    $("#formAgregarInst").validate({ // initialize plugin on the form
        ...
        messages: {
			...
			field01InstNuevaHosp: "Ingrese solo letras"
        },
