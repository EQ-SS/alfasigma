...
function alertGeneral(titulo, tipo){
	swal({
        title: titulo,
        type: tipo,
...
function otrasActividadesHorasCompletas(usuario, horas, titulo) {
    swal({
        title: titulo,
...
function alertSiegfriedCargaDatos(titulo, texto, tipo,tiempo,cb,shlc) {
    swal({
        title: titulo,
		text: texto,
        type: tipo,
