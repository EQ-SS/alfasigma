...
function notificationLimiteBajas(limite) {
    $.notify({
        icon: 'glyphicon glyphicon-ok-sign',
        message: 'Llegaste al límite de ' + limite + ' baja(s)<br> permitidas en el ciclo.'
    },{
        type: "success",
        allow_dismiss: true,
        placement: {
...
function notificationInversionGuardada() {
    $.notify({
        icon: 'glyphicon glyphicon-ok-sign',
        message: 'Inversión registrada'
    },{
        type: "success",
        allow_dismiss: true,
        placement: {
...
function notificationInicioDeLabores() {
    $.notify({
        icon: 'glyphicon glyphicon-ok-sign',
        message: 'Se Iniciaron Labores.'
    },{
        type: "success",
        allow_dismiss: true,
        placement: {
...
function notificationMensajeEniviado() {
    $.notify({
        icon: 'glyphicon glyphicon-ok-sign',
