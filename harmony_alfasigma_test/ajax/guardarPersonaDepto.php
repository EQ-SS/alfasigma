<?php
	...
	if(! $conn){
		...
		if(isset($_POST['idPersonaDepto']) && $_POST['idPersonaDepto'] != ''){
		...
		if($idPersonaDepto == ''){
			$query = "insert into DEPART_PERSON values( 
				NEWID(),
				'".$idDepto."',
				'".$paterno."',
				'".$materno."',
			...
			$query = "update DEPART_PERSON set 
				LNAME = '".$paterno."',
				NAME_FATHER = '".$materno."',
				FNAME = '".$nombre."',
				SPEC_SNR = '".$especialidad."'
				where DEPARTPERS_SNR = '".$idPersonaDepto."' ";
