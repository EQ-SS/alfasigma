<?php
	...
	if(! $conn){
		...
		$idEvenPers = $_POST['idEvenPers'];
		$attended = $_POST['attended'];
		$idEvento = $_POST['idEvento'];
		
		$qActualiuza = "update EVENT_PERS set sync = 0, attended = ".$attended." 
			where EVENT_PERS_SNR = '".$idEvenPers."'";
			
		if(! sqlsrv_query($conn, $qActualiuza)){
			echo "actualiza event_pers ".$qActualiuza;
		}
