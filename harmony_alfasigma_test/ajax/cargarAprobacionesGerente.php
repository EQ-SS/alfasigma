<?php
	...
	if(! $conn){
		...
		while($aproba = sqlsrv_fetch_array($rs)){
			...
			if($estatus == 1){
				echo "$('#tblAprobacionesPersGerente tbody').append('<tr class=\"pointer\" onClick=\"muestraAprobacion(\'".$aproba['PERS_APPROVAL_SNR']."\',\'p\');\"><td style=\"width:5%;\">".$tipo."</td><td style=\"width:10%;\">".$aproba['P_LNAME']."</td><td style=\"width:10%;\">".$aproba['P_MOTHERS_LNAME']."</td><td style=\"width:11%;\">".$aproba['P_FNAME']."</td><td style=\"width:11%;\">".$aproba['esp']."</td><td style=\"width:13%;\">".$aproba['institucion']."</td><td style=\"width:15%;\">".$aproba['direccion']."</td><td style=\"width:12%;\">".$aproba['colonia']."</td><td style=\"width:8%;\" >".$fecha."</td><td style=\"width:5%;\">".$aproba['ruta']."</td></tr>');";
			}else{
				echo "$('#tblAprobacionesPersGerente tbody').append('<tr><td style=\"width:5%;\">".$tipo."</td><td style=\"width:10%;\">".$aproba['P_LNAME']."</td><td style=\"width:10%;\">".$aproba['P_MOTHERS_LNAME']."</td><td style=\"width:11%;\">".$aproba['P_FNAME']."</td><td style=\"width:11%;\">".$aproba['esp']."</td><td style=\"width:13%;\">".$aproba['institucion']."</td><td style=\"width:15%;\">".$aproba['direccion']."</td><td style=\"width:12%;\">".$aproba['colonia']."</td><td style=\"width:8%;\" >".$fecha."</td><td style=\"width:5%;\">".$aproba['ruta']."</td></tr>');";
			}
		}
		...
		while($aproba = sqlsrv_fetch_array($rs)){
			...
			if($estatus == 1){
				echo "$('#tblAprobacionesInstGerente tbody').append('<tr class=\"pointer\" onClick=\"muestraAprobacion(\'".$aproba['inst_approval_snr']."\',\'i\');\"><td style=\"width:5%;\">".$tipo."</td><td style=\"width:18%;\">".$aproba['colonia']."</td><td style=\"width:15%;\">".$aproba['i_name']."</td><td style=\"width:18%;\">".$aproba['i_street1']."</td><td style=\"width:12%;\">".$aproba['i_tel1']."</td><td style=\"width:12%;\">".$aproba['clasificacion']."</td><td style=\"width:12%;\">".$fecha."</td><td style=\"width:8%;\">".$aproba['ruta']."</td></tr>');";
			}else{
				echo "$('#tblAprobacionesInstGerente tbody').append('<tr><td style=\"width:5%;\">".$tipo."</td><td style=\"width:18%;\">".$aproba['colonia']."</td><td style=\"width:15%;\">".$aproba['i_name']."</td><td style=\"width:18%;\">".$aproba['i_street1']."</td><td style=\"width:12%;\">".$aproba['i_tel1']."</td><td style=\"width:12%;\">".$aproba['clasificacion']."</td><td style=\"width:12%;\">".$fecha."</td><td style=\"width:8%;\">".$aproba['ruta']."</td></tr>');";
			}
		}
