<?php
	...
	if(! $conn){
		...
		if(isset($_POST['estatusPersona']) && $_POST['estatusPersona'] != ''){
			$estatus = $_POST['estatusPersona'];
		}else{
			$estatus = '';
		}
		//echo "repre: ".$repre."<br>";
		...
		if($estatus != "" && $estatus != "00000000-0000-0000-0000-000000000000"){
			$queryPersonas .= " and p.STATUS_SNR = '".$estatus."' ";
		}
