	...
	<script>
		...
		$(document).ready(function(){
			...
			$("#btnExportarListadoExcelPlano").click(function(){
				...
				alert("reportes/"+listado[0]+"Excel.php");
		...
		function abreOtrasActividades2(fecha){
			...
			var tipoUsuario = $('#hdnTipoUsuario').val();
			$("#divRespuesta").load("ajax/cargarOtrasActividades.php",{id:'',planVisita:planVisita,fecha:fecha,idUsuario:idUsuario,tipoUsuario:tipoUsuario});
		}
		...
		function muestraOtrasActividades(id){
			...
			var tipoUsuario = $('#hdnTipoUsuario').val();
			$("#divRespuesta").load("ajax/cargarOtrasActividades.php",{id:id,planVisita:planVisita,tipoUsuario:tipoUsuario});
			$('#divReportarOtrasActividades').show();
			$('#over2').show(500);
			$('#fade').show(500);
		}
...
?>
		...
		function nuevaPaginaListados(pagina, ids, listado, estatus){
			$("#divCargando").show();
			$('#divRespuesta').load("ajax/cargar" + listado + ".php",{pagina:pagina,ids:ids,estatus:estatus,hdnFechaIListado:$("#hdnFechaIListado").val(),hdnFechaFListado:$("#hdnFechaFListado").val()});
		}
...
<?php
		...
		if(sqlsrv_num_rows($rsTipoUsuario) > 0){
			while($row = sqlsrv_fetch_array($rsTipoUsuario)){
				...
				$nameDividido = explode('-',$row['LNAME']);
				$nameSinNR = count($nameDividido) >1 ? $nameDividido[1] : $nameDividido[0];
				$row['LNAME'] = $row['USER_NR'].' - '.$nameSinNR;
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
											...
											<select id="sltMotivoBaja" class="form-control">
												...
												while($regMotivoBaja = sqlsrv_fetch_array($rsMotivoBaja)){
													echo '<option value="'.$regMotivoBaja['id'].'">'.$regMotivoBaja['nombre'].'</option>';
												}
?>
											</select>
										</div>
	...
	<script src="js/pages/forms/basic-form-elements.js"></script>
	<script src="js/pages/ui/dialogs.js?v=2.0"></script>
	<script src="js/pages/ui/notifications.js"></script>
	<script src="js/pages/forms/form-validation.js?v=1.0"></script>
