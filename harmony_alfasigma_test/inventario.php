...
<?php
	...
	while($motivo = sqlsrv_fetch_array($rsMotivo)){
		echo "$('#sltMotivoRechazoMuestra').append('<option value=\"".$motivo['id']."\">".$motivo['nombre']."</option>');";
	}
	echo "</script>";
?>
						...
						<div class="header">
							<div class="row margin-0">
								...
								<div class="col-lg-2 col-md-3 col-sm-3 col-xs-6 p-t-10 p-l-0">
									<input type="checkbox" id="chkExistencia" checked="checked" class="filled-in chk-col-blue" />
									<label for="chkExistencia" id="lblExistencia">Existencia</label>
								</div>
								<div class="col-lg-2 col-md-3 col-sm-3 col-xs-6 p-t-10 p-l-0">
									<input type="checkbox" id="chkLoteExpirado" class="filled-in chk-col-blue" />
									<label for="chkLoteExpirado" id="lblLoteExpirado">Lote Expirado</label>
								</div>
								<div class="col-lg-5 col-md-5 col-sm-5 col-xs-6 align-right p-r-0">
<?php
									if($tipoUsuario != 4){
?>
										<button type="button" class="btn bg-indigo waves-effect btn-indigo" id="imgFiltrarAbrirInventario">
										...
										<button type="button" class="btn bg-white col-indigo waves-effect btn-indigo2" id="imgFiltrarCerrarInventario" style="display:none;">
											<span class="display-flex" style="margin: 3px 0; top: 0;">
												<i class="fas fa-filter font-15"></i>
...
<?php
														if($tipoUsuario != 4){
															echo '<td style="width:10%;">Ruta</td>';
														}
?>
...
<?php
														if($tipoUsuario != 4){
															echo "<td style=\"width:12%;\">Transferir</td>";
														}
?>
													</tr>
												</thead>
