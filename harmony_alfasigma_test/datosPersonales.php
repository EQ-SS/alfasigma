...
<div id="tabs-1">
	<div id="tabsPerfilPersona">
				...
				<ul class="nav nav-tabs m-l--5 m-r--5 tab-col-blue p-l-5 tabDatosPer" role="tablist"
					...
					<li role="presentation">
						<a id="aPerfilPersona5" href="#tabBancos" data-toggle="tab" class="show-tooltip">
							...
							<div class="divTooltip">Aseguradoras</div>
							<span class="hidden-txt-tabs">Aseguradoras</span>
						</a>
					</li>
					<li role="presentation">
					...
					<li role="presentation">
						<a id="aPerfilPersona7" href="#tabCategAlfaProducto" data-toggle="tab" class="show-tooltip">
							<i class="material-icons">insert_chart</i>
					...
					<div id="tabPerfilP">
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-7 col-xs-12">
								...
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Consultorio: </p>
										<label id="lblConsultorio"></label>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Días sin Visitar: </p>
										<label id="lblDiasSinVisitar"></label>
									</div>
								</div>
							</div>
							<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
								...
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Categoría Audit: </p><label
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 margin-0">
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Esp Primaria: </p><label
											id="lblEspecialidad"></label>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Sub Especialidad: </p><label
											id="lblSubespecialidad"></label>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Pacientes por semana: </p><label
											id="lblPacientesPorSemana"></label>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Honorarios: </p><label
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Frecuencia: </p><label
											id="lblFrecuencia"></label>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Edad: </p><label
											id="lblEdad"></label>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 margin-0">
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Estilo Disc: </p><label
											id="lblDivMedico"></label>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Paraestatales: </p><label
											id="lblParaestatales"></label>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Segmentación Vessel: </p><label
											id="lblSegmentacionVessel"></label>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Segmentación Ateka: </p><label
											id="lblSegmentacionAteka"></label>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								...
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Segmentación Flonorm: </p><label
											id="lblSegmentacionFlonor"></label>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Segmentación Zirfos: </p><label
											id="lblSegmentacionZifros"></label>
									</div>
								</div>
		...
		?>
					...
					<!--categoria alfasigma por producto-->
					<div class="row" id="tabCategAlfaProducto">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-0">
							<div class="card margin-0">
								<div class="header bg-blue">
									<h2>
										Categoría Alfasigma por Producto
									</h2>
								</div>
								<div class="body">
									<div class="row">
										<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p-t-11">
											<span class="font-bold col-indigo text-inline">Flonorm </span> 
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<label id="lblField_14"></label>
										</div>
									
										<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p-t-11">
											<span class="font-bold col-indigo text-inline">Vessel </span> 
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<label id="lblField_15"></label>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p-t-11">
											<span class="font-bold col-indigo text-inline">Ateka </span> 
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<label id="lblField_16"></label>
										</div>
					
										<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p-t-11">
											<span class="font-bold col-indigo text-inline">Esoxx </span> 
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<label id="lblField_17"></label>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p-t-11">
											<span class="font-bold col-indigo text-inline">Zirfos </span> 
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<label id="lblField_18"></label>
										</div>
										<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p-t-11">
											<span class="font-bold col-indigo text-inline">Categoría Alfasigma </span> 
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<label id="lblField_13"></label>
										</div>
									</div>
								</div>
							</div>
