						...
						<div class="row clearfix">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div class="row">
									...
									<div class="col-md-6" id="divFlonorm">
										<p class="font-bold col-indigo text-inline">Flonorm: </p><label
											id="lblFlonorm"></label>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-6" id="divVessel">
										<p class="font-bold col-indigo text-inline">Vessel: </p><label
											id="lblVessel"></label>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-6" id="divAteka">
										<p class="font-bold col-indigo text-inline">Ateka: </p><label
											id="lblAteka"></label>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-6" id="divZirfos">
										<p class="font-bold col-indigo text-inline">Zirfos: </p><label
											id="lblZirfos"></label>
									</div>
								</div>
								<div class="row" id="divEsoxx">
									<div class="col-md-6">
										<p class="font-bold col-indigo text-inline">Esoxx: </p><label
											id="lblEsoxx"></label>
									</div>
									<div class="col-md-6">
										<p class="font-bold col-indigo text-inline">Categoría Alfasigma: </p><label
											id="lblCategoriaAlfa"></label>
									</div>
								</div>
								<div class="row" id="divMayor">
									<div class="col-md-6">
										<p class="font-bold col-indigo text-inline">Mayoristas: </p><label
											id="lblMayoristas"></label>
									</div>
								</div>
							</div>
						</div>
