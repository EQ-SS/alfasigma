				...
				<div id="tabsPersona">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-0 m-t--20 navbarTabs">
						<ul class="nav nav-tabs m-l--35 m-r--35 tab-col-blue p-l-5" role="tablist"
							...
							<li id="tabPer8" role="presentation">
								<a href="#tabs-8" data-toggle="tab" class="show-tooltip">
									<i class="material-icons">insert_chart</i>
									<div class="divTooltip">Categoría AlfaSigma por Producto</div>
									<span class="hidden-txt-tabs">Categoría AlfaSigma por Producto</span>
								</a>
							</li>
						</ul>
					</div>
										...
										<div class="row">
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Tipo de persona</label>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Apellido Materno *</label>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													...
													<input type="text" id="txtCedulaPersonaNuevo" value=""
														class="form-control" name="cedulaP" placeholder="Cédula" maxlength="8"/>
												</div>
											</div>
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
						...
						?>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													...
													<select id="sltSubEspecialidadPersonaNuevo" class="form-control">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
														<?php
												$rsSubEsp = llenaCombo($conn, 19, 51);
												while($subEsp = sqlsrv_fetch_array($rsSubEsp)){
													echo '<option value="'.$subEsp['id'].'">'.$subEsp['nombre'].'</option>';
												}
						?>
													</select>
												</div>
					...
					?>
						...
						?>
										...
										?>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label>Sexo</label>
													<select id="sltSexoPersonaNuevo" class="form-control">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
														<?php
						...
						?>
										...
										<div class="row">
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Estilo Disc *</label>
													<select class="form-control" id="sltDivMedicoNuevo" name="sltEstiloDisc" >
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione
														</option>
<?php
...
?>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label>Lider de opinion</label>
													<select class="form-control" id="sltLiderOpinionPersonaNuevo">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
														<?php
						...
						?>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label>Paraestatales</label>
													<select class="form-control" id="sltParaestatales">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
														<?php
						...
						?>
										...
										<div class="row">
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Categoría *</label>
													<select name="categoriaP" class="form-control" id="sltCategoriaPersonaNuevo" <?= $tipoUsuario == 2 ? "" : "disabled" ?>>
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
														<?php
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													...
													<select name="estatusP" class="form-control"
														id="sltEstatusPersonaNuevo" <?= $tipoUsuario == 4 ? "disabled" : "" ?> >
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
														<?php
					...
					?>
										...
										<div class="row">
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Segmentación Flonorm *</label>
													<select class="form-control" id="sltSegmentacionFlonorPersonaNuevo" name="sltSegmentacionFlonorPersonaNuevo">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
<?php
...
?>
										...
										<div class="row">
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Segmentación Vessel *</label>
													<select class="form-control" id="sltSegmentacionVesselPersonaNuevo" name="sltSegmentacionVesselPersonaNuevo">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
<?php
...
?>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Segmentación Zirfos *</label>
													<select class="form-control" id="sltSegmentacionZirfosPersonaNuevo" name="sltSegmentacionZirfosPersonaNuevo">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
														<?php
												$rsCategoria = llenaCombo($conn, 481, 6);
												while($regCategoria = sqlsrv_fetch_array($rsCategoria)){
													echo '<option value="'.$regCategoria['id'].'">'.$regCategoria['nombre'].'</option>';
												}
						?>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Segmentación Ateka *</label>
													<select class="form-control" id="sltSegmentacionAtekaPersonaNuevo" name="sltSegmentacionAtekaPersonaNuevo">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
<?php
															$rsSiNo = llenaCombo($conn, 481, 7);
															while($siNo = sqlsrv_fetch_array($rsSiNo)){
																echo '<option value="'.$siNo['id'].'">'.$siNo['nombre'].'</option>';
															}
?>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label>Categoría Audit</label>
													<select class="form-control" id="sltField_12" disabled>
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
<?php
															$rsSiNo = llenaCombo($conn, 481, 12);
															while($siNo = sqlsrv_fetch_array($rsSiNo)){
																echo '<option value="'.$siNo['id'].'">'.$siNo['nombre'].'</option>';
															}
?>
										...
										<div class="row">
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Categoría AlfaSigma *</label>
													<select class="form-control" id="sltField_13" name="field13P">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
<?php
															$rsSiNo = llenaCombo($conn, 481, 13);
															while($siNo = sqlsrv_fetch_array($rsSiNo)){
																echo '<option value="'.$siNo['id'].'">'.$siNo['nombre'].'</option>';
															}
?>
										...
										<div class="row">
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<input type="text" id="txtNumIntInstPersonaNuevo" value=""
														style="display:none;" />
													<label>Torre </label>
										...
										<div class="row">
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													...
													<input name="telefono1P" type="text" value=""
														id="txtTelefonoInstPersonaNuevo" class="form-control"
														maxlength="10" />
												</div>
											</div>
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label>Email</label>
													<input name="emailPerfilP" type="text" class="form-control" value=""
														id="txtEmailInstPersonaNuevo" />
												</div>
											</div>
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group" id="divRuta" hidden>
													<label class="col-red">Ruta *</label>
													<select class="form-control" id="sltRutaPersonaNueva" >
...
?>
								...
								<div id="tabs-8">
									<div class="row">
										<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p-t-11">
											<span class="font-bold col-red">Flonorm *</span> 
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<select class="form-control" id="sltField_14" name="field14PFlonorm">
												<option value="00000000-0000-0000-0000-000000000000">Seleccione</option>
												<?php
													$rsSiNo = llenaCombo($conn, 481, 14);
													while($siNo = sqlsrv_fetch_array($rsSiNo)){
														echo '<option value="'.$siNo['id'].'">'.$siNo['nombre'].'</option>';
													}
?>
										...
										<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p-t-11">
											<span class="font-bold col-red">Vessel *</span> 
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<select class="form-control" id="sltField_15" name="field15P">
												<option value="00000000-0000-0000-0000-000000000000">Seleccione</option>
												<?php
													$rsSiNo = llenaCombo($conn, 481, 15);
													while($siNo = sqlsrv_fetch_array($rsSiNo)){
														echo '<option value="'.$siNo['id'].'">'.$siNo['nombre'].'</option>';
													}
?>
									...
									<div class="row">
										<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p-t-11">
											<span class="font-bold col-red">Ateka *</span> 
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<select class="form-control" id="sltField_16" name="field16P">
												<option value="00000000-0000-0000-0000-000000000000">Seleccione</option>
												<?php
													$rsSiNo = llenaCombo($conn, 481, 16);
													while($siNo = sqlsrv_fetch_array($rsSiNo)){
														echo '<option value="'.$siNo['id'].'">'.$siNo['nombre'].'</option>';
													}
?>
										...
										<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p-t-11">
											<span class="font-bold col-red">Esoxx *</span> 
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<select class="form-control" id="sltField_17" name="field17P">
												<option value="00000000-0000-0000-0000-000000000000">Seleccione</option>
												<?php
													$rsSiNo = llenaCombo($conn, 481, 17);
													while($siNo = sqlsrv_fetch_array($rsSiNo)){
														echo '<option value="'.$siNo['id'].'">'.$siNo['nombre'].'</option>';
													}
?>
									...
									<div class="row">
										<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p-t-11">
											<span class="font-bold col-red">Zirfos *</span> 
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<select class="form-control" id="sltField_18" name="field18P">
												<option value="00000000-0000-0000-0000-000000000000">Seleccione</option>
												<?php
													$rsSiNo = llenaCombo($conn, 481, 18);
													while($siNo = sqlsrv_fetch_array($rsSiNo)){
														echo '<option value="'.$siNo['id'].'">'.$siNo['nombre'].'</option>';
													}
?>
