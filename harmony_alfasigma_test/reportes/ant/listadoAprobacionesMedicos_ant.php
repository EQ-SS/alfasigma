<?php
	...
	$tam = array(100,300,250,250,400,400,100,300,100,250, 200,100,150,100,100,100,100,100,100,100, 150,1250,150,200,200,150,150,200,150,150, 200,150,150,100,100,100,100);//,150,100,100,100, 350,100,100,100,100,100,100,100); //,100,100,50,100,100,100,100,100,100,50,100,100,100,50,100,150,100,100,100,100,100,150,100,100,100,150,100,100,100,50,100,50,100,50,100,50,100,50,100,50,100,100,100,100);
	...
	$qMedicos = "Select
		...
		(case when aps.APPROVED_STATUS=1 then 'Pendiente' when aps.APPROVED_STATUS=2 then 'Aprobado' when aps.APPROVED_STATUS=3 then 'Rechazado' when aps.APPROVED_STATUS=4 then 'Pendiente' end) as Estatus_mov,
