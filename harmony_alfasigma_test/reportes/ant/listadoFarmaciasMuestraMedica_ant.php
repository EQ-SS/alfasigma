<?php
	...
	$tam = array(100,300,250,100,200,300,450,50,300,100, 200,200,100,150,300,150,50,100,100,100, 100,100,100);//,150,150);//,150,150,100,100);//,100, 100,100,150,250,100,100,150,100,100,100, 350,100,100,100,100,100,100,100); //,100,100,50,100,100,100,100,100,100,50,100,100,100,50,100,150,100,100,100,100,100,150,100,100,100,150,100,100,100,50,100,50,100,50,100,50,100,50,100,50,100,100,100,100);
	...
	if($tipo == 1 || $tipo == 2){//excel
		...
		$pdf->Cell(40,5,utf8_decode('LISTADO DE FARMACIAS VISITADAS CON MM'));
		$pdf->Ln();
		$pdf->SetFont('Arial','B',10);
		...
		$tabla = '<table border="0">
			<tr>
				<td>
					<table>
						<tr>
							<td colspan="10" class="nombreReporte">LISTADO DE FARMACIAS VISITADAS CON MM</td>
						</tr>
						<tr>
