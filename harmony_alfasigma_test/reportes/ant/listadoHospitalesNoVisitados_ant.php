<?php
	...
	$tam = array(100,250,250,100,400,300,500,300,100,250, 200,100,150,100,100,150,150);//,150,100,100, 100,100); //,150,150,150,150);//,150,100,100);//,100, 100,100,150,250,100,100,150,100,100,100, 350,100,100,100,100,100,100,100); //,100,100,50,100,100,100,100,100,100,50,100,100,100,50,100,150,100,100,100,100,100,150,100,100,100,150,100,100,100,50,100,50,100,50,100,50,100,50,100,50,100,100,100,100);
				...
				if($tipo != 3){
					if($tipo == 2){
						...
						if($tipo == 1){
							...
							if($j==5){//referencia
								if(strlen($registro[$j]) > 50){
									$tabla .= '<td style="min-width:'.$tam[$j].'px;">'.substr($registro[$j], 0, 49)."...".'</td>';
								}else{
									$tabla .= '<td style="min-width:'.$tam[$j].'px;">'.$registro[$j].'</td>';
								}
							}else{
