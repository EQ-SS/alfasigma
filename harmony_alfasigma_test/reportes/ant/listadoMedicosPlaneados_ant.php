<?php
	...
	$tam = array(100,250,250,250,100,100,300,300,50,50, 200,100,150,100,100,150,50,50,150,150, 150,200,100,100,100,100,100,100,100,500);//, 100,100,100,250,100,100);//,150,100,100,100);//, 100,100,100,100,100,100,100,100); //,100,100,50,100,100,100,100,100,100,50,100,100,100,50,100,150,100,100,100,100,100,150,100,100,100,150,100,100,100,50,100,50,100,50,100,50,100,50,100,50,100,100,100,100);
	...
	foreach(sqlsrv_field_metadata($rsMedicos) as $field){
		if($i < 47){
			if($tipo != 3){
				if($tipo == 2){
					$tabla .= '<td style="min-width:'.$tam[$i].'px;">'.utf8_encode($field['Name']).$i.'</td>'; 
				}else{
					if($tipo == 1){
