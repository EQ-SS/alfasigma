<?php
	...
	$tam = array(100,300,250,200,250,200,200,100,100,100, 100,100,100,200,400,100,100,100,100,300, 300,400,400,250,100,250,100);//,100,100,100, 100,100,150,250,100);//,100,150,100,100,100, 350,100,100,100,100,100,100,100); //,100,100,50,100,100,100,100,100,100,50,100,100,100,50,100,150,100,100,100,100,100,150,100,100,100,150,100,100,100,50,100,50,100,50,100,50,100,50,100,50,100,100,100,100);
	...
	$query = "Select
		...
		(case when aps.APPROVED_STATUS=1 then 'Pendiente' when aps.APPROVED_STATUS=2 then 'Aprobado' when aps.APPROVED_STATUS=3 then 'Rechazado' when aps.APPROVED_STATUS=4 then 'Pendiente' end) as 'Estatus mov',
