<?php
	...
	$tam = array(100,350,350,150,200,250,450,550,300,100, 250,250,150,100,250,200,150,100,150,150, 150,150,150);
	...
	$query = " Select
		...
		CAST(CAST(VI.creation_timestamp as DATE) as VARCHAR(10)) as Fecha_Creacion,
	...
	if($tipo == 2){//excel sin formato
		$nombreArchivo = "../archivos/ListadoHospitalesVisitados".date("dmYHis").".xlsx";
		$spread = new Spreadsheet();
	
		$spread->getProperties()
					->setCreator("Smart-Scale")
					->setTitle("Listado")
					->setDescription("Listado de Hospitales Visitados");
	}
	...
	if($tipo == 2){
		$spread->setActiveSheetIndex(0)
            ->setCellValue('A1', 'LISTADO DE HOSPITALES VISITADOS')
	...
	if($tipo == 2){
		$spread->setActiveSheetIndex(0)
			...
			->setTitle('ListadoHospitalesVisitados');
