<?php
	...
	$tam = array(100,350,350,150,200,250,450,550,150,450, 100,250,250,150,200,150,100,200,100,100, 150,150,150,700);
	...
	$query = "Select
		...
		cast(cast(VP.creation_timestamp as DATE) as nvarchar(10)) as Fecha_Ceacion,
		CONVERT(nvarchar(16), VP.sync_timestamp, 120) as Fecha_Sinc,
