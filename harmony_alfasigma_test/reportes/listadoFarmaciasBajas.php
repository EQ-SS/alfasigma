<?php
	...
	$tam = array(100,350,350,150,200,250,450,550,450,100, 250,250,150,100,150);
	...
	$query = "Select
		...
		categ.name as Categ,
		/*IMS.name as Brick,*/
		CAST(CAST(I.changed_timestamp as DATE) as VARCHAR(10)) as Fecha_Baja
		...
		and U.status=1
		and U.user_type=4
		and I.status_snr = 'BA8FCF48-66A4-42FB-BE8E-5D99A495B89B'
		and U.user_snr in ('".$ids."')
		and I.changed_timestamp between '".$fechaI."' and '".$fechaF."' 
