			...
			<tr>
				<td>
					<table>
						...
						<tr>
							<td colspan="3" class="clienteReporte">ALFASIGMA</td>
						</tr>
						<tr>
	...
	if($tipo == 0){
		...
		if($totalRegistros > $registrosPorPagina){
			...
			if($numPagina > 1){
				...
				$tabla .= "<a href='#' onClick='nuevaPaginaListados(1,\"".$idsEnviar."\",\"listadoSincroniza\",\"".$estatus."\");'>inicio</a>&nbsp;&nbsp;";
				$tabla .= "<a href='#' onClick='nuevaPaginaListados(".$anterior.",\"".$idsEnviar."\",\"listadoSincroniza\",\"".$estatus."\");'>anterior</a>&nbsp;&nbsp;";
			}
			$antes = $numPagina-5;
			$despues = $numPagina+5;
			for($i=1;$i<=$paginas;$i++){
			...
			if($numPagina < $paginas){
				...
				$tabla .= "<a href='#' onClick='nuevaPaginaListados(".$siguiente.",\"".$idsEnviar."\",\"listadoSincroniza\",\"".$estatus."\");'>Siguiente</a>&nbsp;&nbsp;";
				$tabla .= "<a href='#' onClick='nuevaPaginaListados(".$paginas.",\"".$idsEnviar."\",\"listadoSincroniza\",\"".$estatus."\");'>Fin</a>&nbsp;&nbsp;";
			}
