<?php
	...
	$tam = array(100,350,350,150,200,250,450,550,150,450, 100,250,250,250,150,150,150,100,150,150, 200,150,150,150,150,150,700);
	...
	$query = "Select
		...
		(case when I.num_ext<>'0' then upper(I.num_ext) else ' ' end) as Num_Ext,
		...
		cast(cast(VI.creation_timestamp as DATE) as nvarchar(10)) as Fecha_Ceacion,
		CONVERT(nvarchar(16), VI.sync_timestamp, 120) as Fecha_Sinc,
		...
		left outer join codelist as T on I.type_snr = T.clist_snr and T.rec_stat=0
		left outer join codelist as ST on I.subtype_snr = ST.clist_snr and ST.rec_stat=0
		left outer join codelist as formato on I.format_snr = formato.clist_snr and formato.rec_stat=0
		left outer join codelist categ on I.category_snr = categ.clist_snr and categ.rec_stat=0
		left outer join codelist status on I.status_snr = status.clist_snr and status.rec_stat=0
		left outer join codelist TipoVis on TipoVis.clist_snr = VI.visit_code_SNR and TipoVis.rec_stat=0
		left outer join codelist VisAcomp on cast(VisAcomp.clist_snr as varchar(36)) = cast(VI.escort_snr as varchar(36)) and VisAcomp.rec_stat=0
