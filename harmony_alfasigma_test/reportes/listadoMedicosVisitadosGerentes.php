<?php
	...
	$tam = array(100,350,350,350,100,100,150,150,250,250, 250,550,250,150,450,100,200,200,150,100, 100,100,200,200,150,150,100,150,200,200, 250,400,150,100,150,300,150,150,150,150, 700,700);
	...
	if($tipo == 2){//excel sin formato
		$nombreArchivo = "../archivos/ListadoMedicosVisitadosGerentes".date("dmYHis").".xlsx";
		$spread = new Spreadsheet();
	
		$spread->getProperties()
					->setCreator("Smart-Scale")
					->setTitle("Listado")
					->setDescription("Listado de Medicos Visitados por Gerentes");
	}
	...
	if($tipo == 2){
		$spread->setActiveSheetIndex(0)
            ->setCellValue('A1', 'LISTADO DE MÉDICOS VISITADOS POR GERENTES')
	...
	if($tipo == 2){
		$spread->setActiveSheetIndex(0)
			...
			->setTitle('ListadoMedicosVisitadosGerentes');
