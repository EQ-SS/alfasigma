								...
								<div class="card" style="box-shadow: none; border: 1px #f1f1f1 solid;">
									...
									<div class="body table-responsive" style="height: 550px;">
										<table class="table table-hover table-striped pointer" id="tablaListados">
											...
											<tr>
												<td id="listadoMedVisHis"
													onclick="criteriosListado(this.id, 'fecIniListados,fecFinListados,repreListados,statusListados','listadoMedicosVisitadosHistorico.php');">
													Listado de médicos visitados historico
												</td>
											</tr>
											<tr>
												<td id="listadoMedVisProd"
													onclick="criteriosListado(this.id, 'fecIniListados,fecFinListados,repreListados,statusListados','listadoMedicosVisitadosProductos.php');">
													Listado de médicos visitados con productos
												</td>
											</tr>
											<tr>
												<td id="listadoMedVisGtes"
													onclick="criteriosListado(this.id, 'fecIniListados,fecFinListados,repreListados,statusListados','listadoMedicosVisitadosGerentes.php');">
													Listado de médicos visitados por Gtes
												</td>
											</tr>
											<tr>
											...
											<tr>
												<td id="listadoHos"
													onclick="criteriosListado(this.id, 'repreListados,statusListados_i','listadoHospitales.php');">
													Listado de hospitales</td>
											</tr>
											<tr>
												<td id="listadoHosPlan"
													onclick="criteriosListado(this.id, 'fecIniListados,fecFinListados,repreListados,statusListados_i','listadoHospitalesPlaneados.php');">
													Listado de hospitales planeados
												</td>
											</tr>
											<tr>
												<td id="listadoHosVis"
													onclick="criteriosListado(this.id, 'fecIniListados,fecFinListados,repreListados,statusListados_i','listadoHospitalesVisitados.php');">
													Listado de hospitales visitados
												</td>
											</tr>
											<tr>
												<td id="listadoHosNoVis"
													onclick="criteriosListado(this.id, 'fecIniListados,fecFinListados,repreListados,statusListados_i','listadoHospitalesNoVisitados.php');">
													Listado de hospitales no visitados
												</td>
											</tr>
											<tr>
											...
											<tr>
												<td id="listadoHosMuestra"
													onclick="criteriosListado(this.id, 'fecIniListados,fecFinListados,repreListados','listadoHospitalesMuestraMedica.php');">
													Listado de hospitales con muestra médica
												</td>
											</tr>
											<tr>
												<td id="listadoHis"
											...
											<tr>
												<td id="listadoHisTotal"
													onclick="criteriosListado(this.id, 'statusListados,repreListados,periodoListados','listadoHistoricoMedicosVisitadosCicloTotal.php');">
													Listado histórico de médicos visitados por ciclo contacto total
												</td>
											</tr>
											<tr>
											...
											<tr>
												<td id="listadoMedWA"
													onclick="criteriosListado(this.id, 'repreListados,statusListados','listadoMedicosWhatAnalisis.php');">
													Listado de médicos what análisis
												</td>
											</tr>
											<tr>
												<td id="listadoOA"
											...
											<tr>
												<td id="listadoEven"
													onclick="criteriosListado(this.id, 'fecIniListados,fecFinListados,repreListados','listadoEventos.php');">
													Listado de eventos
												</td>
											</tr>
											<tr>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div id="repreListados" style="display:none;">
											...
											if($tipoUsuario != 4){
												...
												$queryrepreListadoss = "select user_snr, user_nr + ' - ' + lname + ' ' + MOTHERS_LNAME + ' ' + fname as nombre from users where USER_SNR in ('".$ids."') ";
												$repreListados = sqlsrv_fetch_array(sqlsrv_query($conn, $queryrepreListadoss));
												$nameDividido = explode('-',$repreListados['nombre']);
												$nameSinNR = count($nameDividido) >2 ? $nameDividido[0].' - '.$nameDividido[2] : $nameDividido[0].' - '.$nameDividido[1];
												$repreListados['nombre'] = $nameSinNR;
