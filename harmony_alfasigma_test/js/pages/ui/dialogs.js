...
function alertFaltanDatosRuta() {
    swal({
        title: "Faltan datos y/o datos incorrectos",
        text: "Seleccione la ruta al que será asignada",
        type: "warning",
        confirmButtonText: "Aceptar"
    });
}
...
function alertPlaneaDomingo() {
    swal({
        title: "No se puede planear en Domingo",
        text: "",
        type: "warning",
        confirmButtonText: "Aceptar"
    });
...
function alertReportaDomingo() {
    swal({
        title: "No se puede reportar en Domingo",
        text: "",
        type: "warning",
        confirmButtonText: "Aceptar"
    });
...
function alertVisAcompa() {
    swal({
        title: "Seleccione la visita acompañada",
        type: "warning",
        confirmButtonText: "Aceptar"
    });
}
...
function alertMotivoRechazo(idProdForm, fecha, producto) {
    ...
    var combo = "<h2>" + prodAjuste + "</h2><div class=\"form-group align-left\"><label class=\"col-red\">Motivo de rechazo *</label><select id=\"sltMotivoRechazoMuestraMM\" class=\"form-control\"><option value=\"00000000-0000-0000-0000-000000000000\">Seleccione</option><option value=\"1425F420-5325-4724-993A-2E299DBA26AB\">RECHAZAR 1</option><option value=\"D4D05924-00FD-408F-9102-9C76F5AA30A7\">RECHAZAR 2</option></select><label id=\"selMotivAlert\" class=\"error2\" style=\"display:none;\">Seleccione un motivo</label></div>";
    swal({
...
function alertMovimientoAprobado() {
    swal({
        title: "Este movimiento ha sido aprobado",
        type: "success",
        timer: 2000,
        showConfirmButton: false,
        showLoaderOnConfirm: true
...
function alertMedicoDuplicado(cedula) {
    swal({
        title: "MEDICO DUPLICADO",
		text: "REVISAR LA CEDULA: "+cedula,
        type: "error",
        confirmButtonText: "Aceptar"
    });
}
function alertConceptoInversiones() {
    swal({
        title: "Oops",
        text: "Ingrese el concepto de la inversión",
        type: "error",
        confirmButtonText: "Aceptar"
    });
}
	
function alertInversionExistente() {
    swal({
        title: "Inversión ya existente",
        text: "Registre una inversión diferente",
        type: "warning",
        confirmButtonText: "Aceptar"
    });
}

function alertEliminarInversion(idInversion) {
	var ids = $('#hdnIds').val();
	if($('#divInversion').is(':visible')){
		var idPersona = '';
	}else{
		var idPersona = $('#hdnIdPersona').val();
	}
    swal({
        title: "¿Está seguro de eliminar la inversión?",
        text: "Se eliminará permanentemente",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: "#DD6B55",
        ...
        if (isConfirm) {
            $('#divRespuesta').load("ajax/eliminarInversion.php", {
                idInversion: idInversion, ids: ids, idPersona: idPersona
            });
        } else {
            swal("Cancelado", "La inversión no fue eliminada", "error");
        }
    });
}

function alertEliminarInversionOk() {
    swal({
...
function alertEliminarInversionError() {
    swal({
        title: "Hubo un error",
        text: "La inversión no fue eliminada",
        type: "error",
        confirmButtonText: "Aceptar",
    });
}

function alertMotivoNoVisita() {
    swal({
        title: "Seleccione el motivo de no visita",
        type: "warning",
        confirmButtonText: "Aceptar"
    });
}

function alertCuadroBasico() {
    swal({
        title: "Seleccione el cuadro báscio",
        type: "warning",
        confirmButtonText: "Aceptar"
    });
}

function alertGenerales() {
    swal({
        title: "Ingrese los comentarios generales",
        type: "warning",
        confirmButtonText: "Aceptar"
    });
}

function alertEliminarMensajeError() {
    swal({
        title: "Hubo un error",
        text: "El mensaje no fue eliminado",
        type: "error",
        confirmButtonText: "Aceptar",
    });
}

function alertEliminarMensajeOk() {
    swal({
...
function alertRepre() {
    swal({
        title: "Seleccione el representante",
        type: "warning",
        confirmButtonText: "Aceptar"
    });
}

function alertErrorOtrasActividades(tabla){
    swal({
        title: "Los siguientes representantes exceden el total de horas en el día",
        text: tabla,
        html: true,
        type: "warning",
        confirmButtonText: "Aceptar"
...
function alertListados(titulo, texto, tipo) {
    swal({
        title: titulo,
		text: texto,
        type: tipo,
