						...
						<div id="tabFiltros2">
							<div id="tabs-1">
								<div id="tblFiltros" width="100%" border="0">
									<div class="row">
										<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 no-margin2">
...
?>
										...
										<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 no-margin2">
											<div class="form-group" style="display:inline-flex;">
												<!--<label class="m-r-5 p-t-5">Categoría: </label>-->
												<select id="sltCategoriaAlfaSigmaFiltro" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000">
														Seleccione categoría AlfaSigma
													</option>
<?php
													$rsCategoria = llenaCombo($conn, 481, 13);
													while($regCategoria = sqlsrv_fetch_array($rsCategoria)){
														echo '<option value="'.$regCategoria['id'].'">'.$regCategoria['nombre'].'</option>';
													}
?>
...
<?php
											if($tipoUsuario != 4){
?>
												<div class="form-group" style="display:inline-flex;" onclick="filtrosUsuarios('personas');">
													<!--<label class="m-r-5 p-t-5">Representante: </label>-->
													<select class='form-control'>
														<option id="sltMultiSelectPersonas">Seleccione el representante</option>
													</select>
												</div>
<?php
											}else{
										...
										<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 no-margin2">
											<div class="form-group" style="display:inline-flex;">
												<div class="form-check">
  													<input class="form-check-input" type="checkbox" id="chkBajaPersona">
  													<label class="form-check-label" for="chkBajaPersona">
    													Baja
  													</label>
												</div>
												<!--<select id="sltBajasFiltro" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000">
														Seleccione motivo baja
													</option>
													<?php
													$rsTipoPersona = llenaComboBajas($conn, 19, 11);
														while($tipo = sqlsrv_fetch_array($rsTipoPersona)){
															echo '<option value="'.$tipo['id'].'">'.$tipo['nombre'].'</option>';
														}
?>
