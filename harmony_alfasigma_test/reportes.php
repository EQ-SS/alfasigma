								...
								<div class="card" style="box-shadow: none; border: 1px #f1f1f1 solid;">
									...
									<div class="body table-responsive" style="height: 550px;">
										<table class="table table-hover table-striped pointer" id="tablaReportes">
											...
											<tr class="esteReporte">
												<td id="reporteInvCiclo"
													onclick="criteriosReporte(this.id,'repre,periodo','reporteInventarioCiclo.php');">
													Reporte de inventario por ciclo
												</td>
											</tr>
										</table>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div id="repre" style="display:none;">
											...
											if($tipoUsuario != 4){
												...
												$queryRepres = "select user_snr, user_nr + ' - ' + lname + ' ' + MOTHERS_LNAME + ' ' + fname as nombre from users where USER_SNR in ('".$ids."') ";
