...
<?php
													$rsTipoInst = llenaCombo($conn, "14", "1");
...
<?php
											$rsCategoria = llenaCombo($conn, "14", "4");
						...
						?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label class="col-red">Nombre de la instituci&oacute;n *</label>
									...
									<div class="row">
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" hidden>
											<div class="form-group">
												<label>Celular</label>
												<input id="txtCelularInstNueva" type="text" value="" class="form-control">
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" hidden>
											<div class="form-group">
												...
												<select id="sltField01InstNueva" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000" selected>Seleccione</option>
													<?php					
													$rsFrecuencia = llenaCombo($conn, "483", "1001");
													while($arrFrecuencia = sqlsrv_fetch_array($rsFrecuencia)){
														echo '<option value="'.$arrFrecuencia['id'].'">'.$arrFrecuencia['nombre'].'</option>';
													}
												?>
									...
									<div class="row" id="farm1" hidden>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Rotación Silanes</label>
												<select id="sltField04InstNueva" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000" selected>Seleccione</option>
													<?php					
													$rsFrecuencia = llenaCombo($conn, "483", "1002");
													while($arrFrecuencia = sqlsrv_fetch_array($rsFrecuencia)){
														echo '<option value="'.$arrFrecuencia['id'].'">'.$arrFrecuencia['nombre'].'</option>';
													}
												?>
									...
									<div class="row" id="farm2" hidden>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												...
												<form>
													...
													<?php
															$rsTipoPaciente = llenaCombo($conn, 483, 1003);
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>No. Emp X día Compra</label>
												<input type="text" id="txtField06InstNueva" class="form-control" />
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>No. Ctes X día Compra</label>
												<select id="sltField07InstNueva" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000" selected>Seleccione</option>
													<?php					
													$rsFrecuencia = llenaCombo($conn, "483", "1004");
													while($arrFrecuencia = sqlsrv_fetch_array($rsFrecuencia)){
														echo '<option value="'.$arrFrecuencia['id'].'">'.$arrFrecuencia['nombre'].'</option>';
													}
												?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>No. Med Cerca farm</label>
												<input type="text" id="txtField08InstNueva" class="form-control" />
											</div>
										</div>
									</div>
									<div class="row" id="farm3" hidden>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												...
												<select id="sltField09InstNueva" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000" selected>Seleccione</option>
													<?php					
													$rsFrecuencia = llenaCombo($conn, "483", "1006");
													while($arrFrecuencia = sqlsrv_fetch_array($rsFrecuencia)){
														echo '<option value="'.$arrFrecuencia['id'].'">'.$arrFrecuencia['nombre'].'</option>';
													}
												?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>No. Most. Atden Ctes</label>
												<input type="text" id="txtField10InstNueva" class="form-control" />
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Recibe Vendedores</label>
												<select id="sltField11InstNueva" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000" selected>Seleccione</option>
													<?php					
													$rsFrecuencia = llenaCombo($conn, "483", "1007");
													while($arrFrecuencia = sqlsrv_fetch_array($rsFrecuencia)){
														echo '<option value="'.$arrFrecuencia['id'].'">'.$arrFrecuencia['nombre'].'</option>';
													}
												?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Venta Genéricos</label>
												<select id="sltField12InstNueva" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000" selected>Seleccione</option>
													<?php					
													$rsFrecuencia = llenaCombo($conn, "483", "1008");
													while($arrFrecuencia = sqlsrv_fetch_array($rsFrecuencia)){
														echo '<option value="'.$arrFrecuencia['id'].'">'.$arrFrecuencia['nombre'].'</option>';
													}
												?>
									...
									<div class="row" id="farm4" hidden>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Mayorista 1</label>
												<input type="text" id="txtField13InstNueva" class="form-control" />
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Mayorista 2</label>
												<input type="text" id="txtField14InstNueva" class="form-control" />
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Mayorista 3</label>
												<input type="text" id="txtField15InstNueva" class="form-control" />
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>No. de Anaquel</label>
												<input type="text" id="txtField16InstNueva" class="form-control" />
											</div>
										</div>
									</div>
									<div class="row" id="farm5" hidden>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>No. visitas por ciclo</label>
												<input type="text" id="txtField17InstNueva" class="form-control" />
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Turnos Pref. Visita</label>
												<select id="sltField18InstNueva" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000" selected>Seleccione</option>
													<?php					
													$rsFrecuencia = llenaCombo($conn, "483", "1009");
													while($arrFrecuencia = sqlsrv_fetch_array($rsFrecuencia)){
														echo '<option value="'.$arrFrecuencia['id'].'">'.utf8_encode($arrFrecuencia['nombre']).'</option>';
													}
												?>
												</select>
											</div>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												...
												<select id="sltField19InstNueva" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000" selected>Seleccione</option>
													<?php					
													$rsFrecuencia = llenaCombo($conn, "483", "1010");
													while($arrFrecuencia = sqlsrv_fetch_array($rsFrecuencia)){
														echo '<option value="'.$arrFrecuencia['id'].'">'.$arrFrecuencia['nombre'].'</option>';
													}
												?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Trabaja Inst. Publica</label>
												<select id="sltField20InstNueva" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000" selected>Seleccione</option>
													<?php					
													$rsFrecuencia = llenaCombo($conn, "483", "1011");
													while($arrFrecuencia = sqlsrv_fetch_array($rsFrecuencia)){
														echo '<option value="'.$arrFrecuencia['id'].'">'.$arrFrecuencia['nombre'].'</option>';
													}
												?>
									...
									<div class="row" id="farm6" hidden>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Tamaño De Farmacia</label>
												<select id="sltField21InstNueva" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000" selected>Seleccione</option>
													<?php					
													$rsFrecuencia = llenaCombo($conn, "483", "1012");
													while($arrFrecuencia = sqlsrv_fetch_array($rsFrecuencia)){
														echo '<option value="'.$arrFrecuencia['id'].'">'.$arrFrecuencia['nombre'].'</option>';
													}
												?>
									...
									<div class="row" id="hospital1" hidden>
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											...
											<form>
												<div class="multiselect">
													...
													<?php
														$rsTipoCliente = llenaCombo($conn, 485, 1001);
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												...
												<input type="text" id="txtField02InstNuevaHosp" class="form-control" />
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Encargado de Compras</label>
												<input type="text" id="txtField03InstNuevaHosp" class="form-control" />
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Distribuidor o Mayorista</label>
												<input type="text" id="txtField04InstNuevaHosp" class="form-control" />
											</div>
										</div>
									</div>
									<div class="row" id="hospital2" hidden>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Decisor de Compra</label>
												<input type="text" id="txtField05InstNuevaHosp" class="form-control" />
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>No. de Servicios</label>
												<input type="text" id="txtField06InstNuevaHosp" class="form-control" />
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Clinica del Dolor</label>
												<select id="sltField07InstNuevaHosp" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000" selected>Seleccione</option>
													<?php					
													$rsFrecuencia = llenaCombo($conn, "485", "1007");
													while($arrFrecuencia = sqlsrv_fetch_array($rsFrecuencia)){
														echo '<option value="'.$arrFrecuencia['id'].'">'.$arrFrecuencia['nombre'].'</option>';
													}
												?>
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<label>Prod. de la Competencia:</label>
											<form>
												<div class="multiselect">
													...
													<?php
														$rsProdCompetencia = llenaCombo($conn, 485, 1008);
									...
									<div class="row" id="hospital3" hidden>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Cual es el Precio</label>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												<label>Compra Vealian</label>
												<select id="sltField10InstNuevaHosp" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000" selected>Seleccione</option>
													<?php					
													$rsFrecuencia = llenaCombo($conn, "485", "1010");
													while($arrFrecuencia = sqlsrv_fetch_array($rsFrecuencia)){
														echo '<option value="'.$arrFrecuencia['id'].'">'.$arrFrecuencia['nombre'].'</option>';
													}
												?>
