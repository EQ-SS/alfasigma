<?php
	...
	$tam = array(100,350,350,100,200,250,450,550,100,450, 100,250,250,200,100,150,250,150,100,150, 150,150,150,150,150);
	...
	if($tipo == 2){//excel sin formato
		$nombreArchivo = "../archivos/listadoFarmaciasMuestraMedica".date("dmYHis").".xlsx";
	...
	if($tipo == 1){//excel con formato
		...
		header("Content-Disposition: filename=listadoFarmaciasMuestraMedica.xls");
	...
	if($tipo == 2){
		$spread->setActiveSheetIndex(0)
			...
			->setTitle('listadoFarmaciasMuestraMedica');
