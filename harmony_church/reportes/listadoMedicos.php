<?php
	...
	$tam = array(100,350,350,350,150,150,200,200,350,550, 100,300,450,100,300,250,250,150,150,150, 250,250,150,100,100,100,100,100,100,100, 250,200,250,400,150,150,150,150,150,150, 150,150); 
	...
	$qMedicos = "Select 
		...
		P.mobile as Celular, 
		P.email1 as Email, 
		PERFIL1.name as 'Medico presc. cat. Lubricantes nasales', 
		PERFIL2.name as 'Lider de opinion', 
		PERFIL3.name as 'Segmento x Potencial', 
		PERFIL4.name as 'Rango Edad', 
		/*PERFIL5.name as 'Referidor', */
		PUD.field_01 as 'Hospital',
		PUD.field_02 as 'Folio',
		...
		from person P
		inner join pers_srep_work PSW on PSW.pers_snr=P.pers_snr and PSW.rec_Stat=0
		...
		inner join users as U on U.user_snr = PSW.user_snr and U.rec_stat=0
		...
		left outer join codelist PERFIL1 on PUD.field_01_snr = PERFIL1.clist_snr and PERFIL1.status=1
		left outer join codelist PERFIL2 on PUD.field_02_snr = PERFIL2.clist_snr and PERFIL2.status=1
		left outer join codelist PERFIL3 on PUD.field_03_snr = PERFIL3.clist_snr and PERFIL3.status=1
		left outer join codelist PERFIL4 on PUD.field_04_snr = PERFIL4.clist_snr and PERFIL4.status=1
		left outer join codelist PERFIL5 on PUD.field_05_snr = PERFIL5.clist_snr and PERFIL5.status=1
