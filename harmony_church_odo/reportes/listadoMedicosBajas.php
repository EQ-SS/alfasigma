<?php
	...
	$tam = array(350,350,350,200,200,200,350,450,100,200, 200,200,200,100,250,250,150,150,150,200, 200,200,200,150);
	...
	$qMedicos = "Select
		...
		P.tel2 as Tel2,
		P.mobile as Celular,
		cast(cast(aps.approved_date as DATE) as nvarchar(10)) as Fecha_Baja,
		'INACTIVO' as 'Estatus de baja'
		...
		and pa.plw_del_status_snr = '04207D8D-0AA7-4E60-9FAB-B36F3C83EFA1' 
		/*and ST.NAME <> 'ACTIVO' */
