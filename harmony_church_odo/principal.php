	...
	<script>
		...
		$(document).ready(function(){
			...
			$('#imgEventos').click(function(){
				...
				$('#divRespuesta').load("ajax/cargarEventos.php",function(){
			...
			$('#btnLimpiarFiltros').click(function(){
				...
				$('#txtApellidoMaternoFiltro').val('');
				$('#sltSexoFiltro').val('');
				$('#sltEspecialidadFiltro').val('00000000-0000-0000-0000-000000000000');
				$('#sltSubEspecialidadFiltro').val('00000000-0000-0000-0000-000000000000');
				...
				$('#sltPacientesXsemanaFiltros').val('00000000-0000-0000-0000-000000000000');
				$('#sltHonorariosFiltro').val('00000000-0000-0000-0000-000000000000');
				$('#sltTipoInstFiltroPersonas').val('00000000-0000-0000-0000-000000000000');
				$('#sltSubtipoInstFiltro').val('00000000-0000-0000-0000-000000000000');
				//$('#btnEjecutarFiltro').click();
				$('#cardInfMedicos').show();
				$('#divMedicosInactivos').hide();
				muestraEditaPersona = 0;
				$("#rbtTodosFiltroPersonas").prop("checked", false); 
				$("#rbtGeoSiFiltroPersonas").prop("checked", false); 
				$("#rbtGeoNoFiltroPersonas").prop("checked", false); 
			});
			...
			$("#btnGuardarPersonaNuevo").click(function () {
				...
				if ($("#formAgregarPersona").valid()) {
					...
					$("#divRespuesta").load("ajax/guardarPersona.php", {
						...
						field01_snr: field01_snr,
						field02_snr: field02_snr,
						field03_snr: field03_snr,
						field04_snr: field04_snr,
						field05_snr: field05_snr,
						idInst: idInst,
						corto: corto,
						largo: largo,
						generales: generales,
			...
			$('#sltAnioFechaNacimientoPersonaNuevo').change(function (){
			...
			$('#btnAceptarCambiarRutaPersonas').click(function(){
				...
				$('#over').show(500);
				$('#fade').show(500);
				$('#divRespuesta').load("ajax/cargarRutasCambioPersonas.php", {idUsuario:idUsuario, ids:ids, tipoUsuario:tipoUsuario});
			...
			*/
			...
			$('#sltTipoInstFiltroPersonas').change(function(){
				tipoInst = $('#sltTipoInstFiltroPersonas').val();
				$('#divRespuesta').load("ajax/cargarSubtipoFiltros.php",{tipoInst:tipoInst});
			});
			...
			$('#btnLimpiarFiltrosInst').click(function(){
				...
				$("#rbtTodosrbtTodos").prop("checked", false); 
				$("#rbtGeoSi").prop("checked", false); 
				$("#rbtGeoNo").prop("checked", false);
			...
			$("#btnGuardarInstNueva").click(function () {
				...
				if ($("#formAgregarInst").valid()) {
					...
					field04InstNueva = $("#sltField04InstNueva").val();
					//field05InstNueva = $("#sltField05InstNueva").val();
					field06InstNueva = $("#txtField06InstNueva").val();
					field07InstNueva = $("#sltField07InstNueva").val();
					field08InstNueva = $("#txtField08InstNueva").val();
					field09InstNueva = $("#sltField09InstNueva").val();
					field10InstNueva = $("#txtField10InstNueva").val();
					field11InstNueva = $("#sltField11InstNueva").val();
					field12InstNueva = $("#sltField12InstNueva").val();
					field13InstNueva = $("#txtField13InstNueva").val();
					field14InstNueva = $("#txtField14InstNueva").val();
					field15InstNueva = $("#txtField15InstNueva").val();
					field16InstNueva = $("#txtField16InstNueva").val();
					field17InstNueva = $("#txtField17InstNueva").val();
					field18InstNueva = $("#sltField18InstNueva").val();
					field19InstNueva = $("#sltField19InstNueva").val();
					field20InstNueva = $("#sltField20InstNueva").val();
					field21InstNueva = $("#sltField21InstNueva").val();
					
					//field01InstNuevaHosp = $("#sltField01InstNuevaHosp").val();
					...
					field07InstNuevaHosp = $("#sltField07InstNuevaHosp").val();
					//field08InstNuevaHosp = $("#sltField08InstNuevaHosp").val();
					field09InstNuevaHosp = $("#txtField09InstNuevaHosp").val();
					field10InstNuevaHosp = $("#sltField10InstNuevaHosp").val();
					
					field05InstNueva = '';
					for(i=0;i<= $("#hdnTotalChecksTipoPaciente").val(); i++){
						if($("#tipoPaciente" + i).prop('checked')){
							field05InstNueva += $('#tipoPaciente'+i).val() + ";";
						}
					}
					
					field08InstNuevaHosp = '';
					for(i=0;i<= $("#hdnTotalChecksProdCompetencia").val(); i++){
						if($("#prodCompetencia" + i).prop('checked')){
							field08InstNuevaHosp += $('#prodCompetencia'+i).val() + ";";
						}
					}
					...
					for(i=0;i<= $("#hdnTotalChecksTipoCliente").val(); i++){
						if($("#tipoCliente" + i).prop('checked')){
							field01InstNuevaHosp += $('#tipoCliente'+i).val() + ";";
						}
					}
					*/
					//alert(estatus);
			...
			$('#btnAceptarProductoSeleccionado').click(function(){
				...
				$('#divRespuesta').load("ajax/cargarProductosSeleccionados.php",{funcion:funcion,idProducto:idProducto,idProdForm:idProdForm,existencia:existencia,precio:precio,pedido:pedido,sugerido:sugerido,agotado:agotado,cadena:cadena,promociones:promociones});
			});
			...
			$("#btnReporte").click(function(){
				...
				$("#divReporteReporteador").load("reportes/"+reporte,{hdnFechaI:fechaInicio,hdnFechaF:fechaFin,hdnEstatus:estatus,periodo:periodo,hdnIdsProductos:productos,hdnIDS:ids,hdnTipoReporte:'0',hdnEstatusInst:estatusI,hdnCicloListado:ciclo});
		...
		function nuevaPagina(pagina,hoy,ids,visitados){
			...
			pacXsem = $('#sltPacientesXsemanaFiltros').val();
			...
			*/
			...
			nombreList = $('#txtBuscarMedico').val();
			cargandoMedico();
										...
										<div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
											<div class="form-group">
												...
												<select id="sltMotivoRechazo" class="form-control">
													<option value="00000000-0000-0000-0000-000000000000">Seleccione</option>
<?php
														$rsMotivoRechazo = llenaCombo($conn, 297, 1);
