...
if($funcion == 1){
	...
	while($producto = sqlsrv_fetch_array($rs)){
		...
		echo "$('#tblProductoSeleccionado tbody').append('<tr><td width=\"50%\" ><input type=\"hidden\" id=\"hdnIdProdForm".$i."\" value=\"".$producto['prodform_snr']."\"/>".$producto['producto']." ".$producto['presentacion']."</td><td width=\"12%\" align=\"center\"><input type=\"text\" id=\"txtExistenciaStock".$i."\" size=\"4\" value=\"0\" style=\"text-align:right;\"/></td><td width=\"12%\" align=\"center\"><input type=\"text\" id=\"txtPrecioStock".$i."\" size=\"4\" value=\"0\" style=\"text-align:right;\"/></td><td width=\"10%\" align=\"center\"><input type=\"text\" id=\"txtPedidoStock".$i."\" size=\"4\" value=\"0\" style=\"text-align:right;\"/></td><td width=\"15%\" align=\"center\"><input type=\"text\" id=\"txtSugerido".$i."\" size=\"4\" value=\"0\" style=\"text-align:right;\"/></td><td width=\"15%\" align=\"center\"><button onClick=\"cargarCompetidor(\'".$idProducto."\', \'".$producto['producto']."\');\">...</button></td></tr>');";
	}
	...
	for($i=0;$i<count($idProdForm);$i++){
		...
		/*$('#tblProductosSeleccionados tbody').append('<tr><td width=\"66%\"><input type=\"hidden\" id=\"hdnIdProdFormS' + idHidden + '\" value=\"".$rsProdForm['idProdform']."\"/>".$rsProdForm['producto']." - ".$rsProdForm['presentacion']."</td><td width=\"10%\" align=\"center\"><input type=\"text\" id=\"txtPedidoS' + idHidden + '\" size=\"4\" value=\"".$pedido[$i]."\" style=\"text-align:right;\"/></td><td width=\"10%\" align=\"center\"><input type=\"text\" id=\"txtExistenciaS' + idHidden + '\" size=\"4\" value=\"".$existencia[$i]."\" style=\"text-align:right;\"/></td><td width=\"10%\" align=\"center\"><input type=\"text\" id=\"txtPrecioS' + idHidden + '\" size=\"4\" value=\"".$precio[$i]."\" style=\"text-align:right;\"/></td><td width=\"10%\" align=\"center\"><img width=\"20\" src=\"iconos/eliminar.png\" /></td></tr>');*/
		$('#tblProductosSeleccionados tbody').append('<tr><td width=\"66%\"><input type=\"hidden\" id=\"hdnIdProdFormS' + idHidden + '\" value=\"".$rsProdForm['idProdform']."\"/>".$rsProdForm['producto']." - ".$rsProdForm['presentacion']."</td><td width=\"10%\" align=\"center\"><input type=\"text\" id=\"txtExistenciaS' + idHidden + '\" size=\"4\" value=\"".$existencia[$i]."\" style=\"text-align:right;\"/></td><td width=\"10%\" align=\"center\"><input type=\"text\" id=\"txtPrecioS' + idHidden + '\" size=\"4\" value=\"".$precio[$i]."\" style=\"text-align:right;\"/></td><td width=\"10%\" align=\"center\"><input type=\"text\" id=\"txtPedidoS' + idHidden + '\" size=\"4\" value=\"".$pedido[$i]."\" style=\"text-align:right;\"/></td><td width=\"10%\" align=\"center\"><input type=\"text\" id=\"txtSugeridoS' + idHidden + '\" size=\"4\" value=\"".$sugerido[$i]."\" style=\"text-align:right;\"/></td><td width=\"10%\" align=\"center\"><img width=\"20\" src=\"iconos/eliminar.png\" /></td></tr>');";
	}
	echo "
