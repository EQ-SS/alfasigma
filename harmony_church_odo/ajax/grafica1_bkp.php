...
$consCategorias = array('AA', 'A', 'B', 'C', 'NC');
...
$queryGrafica1 = "with chart3 as (
	...
	while($regGrafica1 = sqlsrv_fetch_array($rsGrafica1)){
		...
		switch ($regGrafica1['categ']){
			case "AA":
				$arrVNV['AA']['V'] += $regGrafica1['visit'];
				$arrVNV['AA']['N'] += $regGrafica1['novis'];
				break;
			case "A":
				$arrVNV['A']['V'] += $regGrafica1['visit'];
				$arrVNV['A']['N'] += $regGrafica1['novis'];
				break;
			case "B":
				$arrVNV['B']['V'] += $regGrafica1['visit'];
				$arrVNV['B']['N'] += $regGrafica1['novis'];
				break;
			case "C":
	...
	$nombres = '{"label": "AA"},{"label": "A"},{"label": "B"},{"label": "C"},{"label": "NC"}';
	$valores_Frec_A = '{"value": "'.$arrCategorias['AA']['A'].'"},{"value": "'.$arrCategorias['A']['A'].'"},{"value": "'.$arrCategorias['B']['A'].'"},{"value": "'.$arrCategorias['C']['A'].'"},{"value": "'.$arrCategorias['NC']['A'].'"}';
	$valores_Frec_B = '{"value": "'.$arrCategorias['AA']['B'].'"},{"value": "'.$arrCategorias['A']['B'].'"},{"value": "'.$arrCategorias['B']['B'].'"},{"value": "'.$arrCategorias['C']['B'].'"},{"value": "'.$arrCategorias['NC']['B'].'"}';
	$valores_Frec_C = '{"value": "'.$arrCategorias['AA']['C'].'"},{"value": "'.$arrCategorias['A']['C'].'"},{"value": "'.$arrCategorias['B']['C'].'"},{"value": "'.$arrCategorias['C']['C'].'"},{"value": "'.$arrCategorias['NC']['C'].'"}';
	$valores_Frec_D = '{"value": "'.$arrCategorias['AA']['D'].'"},{"value": "'.$arrCategorias['A']['D'].'"},{"value": "'.$arrCategorias['B']['D'].'"},{"value": "'.$arrCategorias['C']['D'].'"},{"value": "'.$arrCategorias['NC']['D'].'"}';
