<?php
	...
	if(! $conn){
		...
		if(isset($_POST['pacXsem']) && $_POST['pacXsem'] != '' && $_POST['pacXsem'] != '00000000-0000-0000-0000-000000000000'){
			$pacXsem = $_POST['pacXsem'];
		}else{
			$pacXsem = '';
		}
		if(isset($_POST['honorarios']) && $_POST['honorarios'] != '' && $_POST['honorarios'] != '00000000-0000-0000-0000-000000000000'){
		...
		$queryPersonas = "select p.pers_snr, p.LNAME,  p.MOTHERS_LNAME, p.FNAME, c.NAME as especialidad, 
				...
				p.diffvis_snr, 
				i.type_snr, i.subtype_snr, i.num_ext, 
		...
		if($pacXsem != ''){
			$queryPersonas .= " and p.patperweek_snr = '".$pacXsem."' ";
		}
		if($honorarios != ''){
			$queryPersonas .= " and p.fee_type_snr = '".$honorarios."' ";
		}
		if($frecuencia != ''){
