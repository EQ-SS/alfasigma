...
<?php
																	...
																	while($acom = sqlsrv_fetch_array($rsAcom)){
																		...
																		echo '<input type="checkbox" id="'.$idChk.'" class="filled-in chk-col-red"  onclick="agregaDesVisAcompaInst(\''.$acom['NAME'].'\',\''.$idChk.'\');" value="'.$acom['CLIST_SNR'].'"/>';
																		echo '<label for="'.$idChk.'">'.$acom['NAME'].'</label>';
																	}
?>
																</div>
															</div>
											...
											<table border="0" width="100%" id="tblProductosSeleccionados"
												...
												<thead class="bg-grey">
													<tr>
														...
														<td width="10%">Desplazamiento</td>
														<td width="10%">Existencia</td>
														<td width="10%">Precio</td>
														<!--<td width="10%">Sugerido</td>-->
														<td width="10%" align="right">Eliminar</td>
													</tr>
												</thead>
												<tbody height="140px">
												</tbody>
