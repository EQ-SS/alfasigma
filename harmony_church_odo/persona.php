						...
						?>
								...
								<?php
										...
										?>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Sexo *</label>
...
?>
						...
						?>
										...
										<div class="row">
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Potencial *</label>
...
?>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Fecha de alta *</label>
													<input type="text" id="txtFechaAltaPersonaNuevo" class="form-control"
														value="" readonly />
												</div>
											</div>
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
