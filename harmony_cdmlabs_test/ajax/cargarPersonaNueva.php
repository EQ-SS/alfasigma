...
if(! $conn){
	...
	if($idPersona != ''){
		$queryPersona = "select p.FNAME, p.LNAME, p.mothers_lname,
			...
			plw.tel as telEmpresa, plw.email as mailEmpresa, plw.num_int as interior,
			plw.TOWER, plw.floor, plw.office, plw.department, p.patperweek_snr, p.PERSTYPE_SNR,  
			field_01_snr,field_02_snr,
		...
		$cedula = '';
		$frecuencia = '64E242F7-1DD6-4374-93DA-33C37E8AAE17';
		//$idInst = '';
		$email1Personal = '';
		$telPersonal = '';
		$email1Personal2 = '';
		...
		$estatus = 'C3C180DC-76B8-48D8-9581-A4345BCE689A';
