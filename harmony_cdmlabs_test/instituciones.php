				...
				?>
								...
								<div id="tbConsultorios">
									...
									echo "<div class='col-white'>
												<p style='position:absolute; top:20px;'>
													<span class='font-bold'>Total de registros: </span>
													<span id='tblFarmaciasnumReg'>".$totalRegistrosConsul."</span>
												</p>
											</div>";
									...
									while($consultorio = sqlsrv_fetch_array($queryInst20Consul)){
										...
										$datosInst = "<b>Dirección: </b><span>".$consultorio['DIRECCION'].", ";
										$datosInst .= $consultorio['CPOSTAL'].", COLONIA: ".$consultorio['COLONIA'].", ";
										$datosInst .= $consultorio['POBLACION'].", ";
										$datosInst .= $consultorio['ESTADO']."</span>";
                                        
                                        $idContConsul++;
									
										echo "<tr  id='trfar".$idContConsul."' onClick='enviaIdTrInst(this.id);'>
											<td>
												<div class='row'>
