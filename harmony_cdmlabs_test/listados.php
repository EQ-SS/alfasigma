								...
								<div class="card" style="box-shadow: none; border: 1px #f1f1f1 solid;">
									...
									<div class="body table-responsive" style="height: 550px;">
										<table class="table table-hover table-striped pointer" id="tablaListados">
											...
											<tr>
												<td id="listadoAltaHos"
													onclick="criteriosListado(this.id, 'fecIniListados,fecFinListados,repreListados,statusListados_i','listadoHospitalesAltas.php');">
													Listado de altas de hospitales
												</td>
											</tr>
											<tr>
												<td id="listadoBajaHos"
													onclick="criteriosListado(this.id, 'fecIniListados,fecFinListados,repreListados','listadoHospitalesBajas.php');">
													Listado de bajas de hospitales
												</td>
											</tr>
											<tr>
											...
											<tr>
												<td id="listadoHisFarm"
													onclick="criteriosListado(this.id, 'statusListados_i,repreListados,periodoListados','listadoHistoricoFarmaciasVisitadasCiclo.php');">
													Listado histórico de farmacias visitadas por ciclo
												</td>
											</tr>
											<tr>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div id="repreListados" style="display:none;">
											...
											if($tipoUsuario != 4){
												...
												$queryrepreListadoss = "select user_snr, user_nr as ruta, lname + ' ' + MOTHERS_LNAME + ' ' + fname as nombre from users where USER_SNR in ('".$ids."') ";
												...
												$repreListados['nombre'] = $repreListados['ruta'].' - '.$nameSinNR;
