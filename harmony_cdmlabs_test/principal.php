		...
		$(document).ready(function(){
				...
				$("#btnGuardarPersonaNuevo").click(function () {
					...
					if ($("#formAgregarPersona").valid()) {
						...
						field01_snr = $('#sltField01').val();//rango de edad
						field02_snr = $('#sltField02').val();//compra
				...
				*/
				...
				$('#sltTipoInstNueva').change(function(){
					...
					if(tipoInst == '986B6229-F56F-4D8B-9B77-47FCDC072E87'){
						$('#sltFrecuenciaInstNueva').val('30A49AC2-3287-459E-88C9-E4370D86D615');
					}else{
						$('#sltFrecuenciaInstNueva').val('C63FC122-E501-4108-9703-985F3D85E1A0');
					}
				...
				$('#btnAceptarAprobacion').click(function(){
					...
					if(idPersApproval != ''){
						$("#divRespuesta").load("ajax/persAprobacion.php",{idPersApproval:idPersApproval,idUser:idUser},function(){
							alert('Este movimiento ha sido aprobado');
						});
			...
			function calculaCategoria(){
				...
				puntos = 0;
				categoria = 0;
				var arrHonorarios = [ 0, 6, 8, 10 ];
				var arrEspecialidad = [ 0, 6, 8, 8, 10, 9, 3, 5, 3 ];
				var arrPacientesSemana = [ 0, 4, 6, 8, 10 ];
				var arrCompras = [ 0, 9, 10, 7 ];
					...
					<li>
						...
						<ul class="ml-menu">
							...
							<li id="imgInstituciones" class="hover2" style="display:none;">
								<a>
									<!--<i class="fas fa-city font-21 m-l--7"></i>-->
