								...
								<div id="tabs-1">
									<div id="tblDatosGnr">
										<div class="row">
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Tipo de Médico *</label>
										...
										<div class="row">
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label class="col-red">Fecha de cumpleaños *</label>
						...
						?>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													...
													<select class="form-control" id="sltFrecuenciaPersonaNuevo" <?=($tipoUsuario==4) ? "disabled" : "" ?>>
														<option value="00000000-0000-0000-0000-000000000000" hidden>
																Seleccione</option>
								<?php
...
?>
						...
						?>
											...
											<!--<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													...
													<select class="form-control" id="sltDificultadVisita" style="display:none">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
						<?php
						...
						?>
													...
													<select class="form-control" id="sltField04" disabled>
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
						<?php
															/*$rsField04 = llenaCombo($conn, 481, 4);
															while($field04 = sqlsrv_fetch_array($rsField04)){
																echo '<option value="'.$field04['id'].'">'.$field04['nombre'].'</option>';
															}*/
						?>
													</select>
												</div>
					...
					?>
										...
										<div class="row">
											...
											<!--<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label>Segmentación Flonor</label>
													<select class="form-control" id="sltSegmentacionFlonorPersonaNuevo">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
														<?php
						...
						?>
										...
										<div class="row">
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label>Segmentación Vessel</label>
													<select class="form-control" id="sltSegmentacionVesselPersonaNuevo">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
														<?php
						...
						?>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label>Segmentación Zirfos</label>
													<select class="form-control" id="sltSegmentacionZirfosPersonaNuevo">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
														<?php
						...
						?>
											...
											<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-0">
												<div class="form-group">
													<label>Segmentación Ateka</label>
													<select class="form-control" id="sltSegmentacionAtekaPersonaNuevo">
														<option value="00000000-0000-0000-0000-000000000000" hidden>
															Seleccione</option>
														<?php
								...
								<div id="tabs-3">
									<div class="row p-t-20">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 font-15">
											<?php
											$rsPasatiempos = llenaCombo($conn, 19,22);
											$contador = 1;
