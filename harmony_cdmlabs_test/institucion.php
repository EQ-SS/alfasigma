						...
						?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												...
												<select name="estatusI" id="sltEstatusInstNueva" class="form-control no-style-disabled" <?=($tipoUsuario==4) ? "disabled" : "" ?>>
													<?php
						...
						?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="form-group">
												...
												<select id="sltFrecuenciaInstNueva" class="form-control" <?=($tipoUsuario==4) ? "disabled" : "" ?>>
													<option value="00000000-0000-0000-0000-000000000000" selected>Seleccione</option>
													<?php					
