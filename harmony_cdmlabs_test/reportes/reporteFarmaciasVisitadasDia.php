<?php
	...
	$qMedicos = "DECLARE @fecha_inicio Date, 
		...
		*/
		...
		(case when PATINDEX('%VACANTE%', U.lname)=0 then cast(isnull(U.EMAIL,'0') as int) else 0 end) as CUOTA,
		...
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F1.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2 /*and name not like @CITA*/) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_1,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F2.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_2,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F3.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_3,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F4.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_4,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F5.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_5,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F6.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_6,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F7.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_7,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F8.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_8,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F9.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_9,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F10.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_10,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F11.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_11,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F12.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_12,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F13.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_13,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F14.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_14,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F15.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_15,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F16.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_16,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F17.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_17,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F18.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_18,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F19.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_19,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F20.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_20,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F21.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_21,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F22.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_22,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F23.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_23,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F24.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_24,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F25.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 
		) as Vis_Dia_25,
		
		/* DESPLEGADO DE VISITAS ACOMP */
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F1.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_1,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F2.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_2,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F3.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_3,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F4.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_4,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F5.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_5,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F6.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_6,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F7.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_7,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F8.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_8,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F9.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_9,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F10.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_10,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F11.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_11,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F12.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_12,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F13.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_13,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F14.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_14,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F15.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_15,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F16.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_16,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F17.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_17,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F18.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_18,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F19.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_19,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F20.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_20,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F21.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_21,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F22.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_22,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F23.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_23,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F24.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_24,
		(select count(*) from visitinst VP1 where VP1.user_snr = U.user_snr and VP1.rec_stat=0 and VP1.visit_date = F25.FECHA and VP1.visit_code_snr<>@no_vis and VP1.inst_snr in (select UT.inst_snr from USER_TERRIT UT, INST I where UT.rec_stat=0 and UT.inst_snr = I.inst_snr and I.inst_type=2) and VP1.inst_snr<>@cad0 and U.user_type=4 and (substring(escort_snr,1,36)=@VAcom or substring(escort_snr,38,36)=@VAcom)
		) as VAcom_25,
	...
	if($tipo == 1 || $tipo == 2){//excel
		...
		header("Content-Disposition: filename=reporteFarmaciasVisitadasDia.xls");
		...
		$pdf->Cell(40,5,utf8_decode('Reporte de Farmacias Visitadas por Dia'));
		$pdf->Ln();
		$pdf->SetFont('Arial','B',10);
			...
			$tabla .= '<table border="0">
				<tr>
					<td>
						<table>
							<tr>
								<td colspan="2" class="nombreReporte">Reporte de Farmacias Visitadas por Dia</td>
							</tr>
							<tr>
