<?php
	...
	$qMedicos = "DECLARE @STATUS AS VARCHAR(36)
		...
		SET @STATUS = 'C3C180DC-76B8-48D8-9581-A4345BCE689A'
		SET @DIAS_IN='".$fechaI."'
		SET @DIAS_FIN='".$fechaF."'
		/*
		...
		*/
		...
		And VP.visit_date Between @DIAS_IN And @DIAS_FIN
		and P.status_snr = @STATUS
		And VP.escort_snr in ('FAD471D8-3401-47F9-B03C-897C43D69B12')
		) AS Vis_GteDto,
		...
		and VP.visit_date Between @DIAS_IN And @DIAS_FIN 
		and P.status_snr = @STATUS
		And VP.escort_snr='04E98BB1-0B87-464E-B4BA-2140359C405E'
		) AS Vis_GteNac 
