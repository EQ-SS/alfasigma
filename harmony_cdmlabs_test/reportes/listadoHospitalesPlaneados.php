<?php
	...
	$tam = array(100,350,350,100,200,450,550,100,450,100, 250,250,250,100,200,150,150,150,200,150, 550);
	...
	if($tipo == 2){//excel sin formato
		$nombreArchivo = "../archivos/ListadoHospitalesPlaneados".date("dmYHis").".xlsx";
		$spread = new Spreadsheet();
	
		$spread->getProperties()
					->setCreator("Smart-Scale")
					->setTitle("Listado")
					->setDescription("Listado de Hospitales Planeados");
	}
	...
	if($tipo == 2){
		$spread->setActiveSheetIndex(0)
            ->setCellValue('A1', 'LISTADO DE HOSPITALES PLANEADOS')
	...
	if($tipo == 2){
		$spread->setActiveSheetIndex(0)
			...
			->setTitle('ListadoHospitalesPlaneados');
