<?php
	...
	$tam = array(100,350,350,350,150,150,250,250,250,450, 100,100,450,100,250,250,200,200,100,100, 250,150,150,150,100,200,200,200,150,100, 150,200,150,150,150,150,500,500);
	...
	$qMedicos = "Select DISTINCT
		...
		where cd.rec_stat = 0 AND CD.C_DATE=VP.Visit_Date and cd.c_day = 0) 
		then 'DIA NO HABIL' else '' end) as Vis_Dia_Habil*/
