<?php
	...
	$tam = array(100,350,350,100,200,450,550,450,100,250, 250,250,200,100,150,250,150,150,150,150 ,150);
	...
	$query = "Select
		...
		CAST(CAST((select top 1 visit_date from VISITINST VI where VI.USER_SNR=U.USER_SNR and VI.INST_SNR=I.INST_SNR order by VISIT_DATE desc) as DATE) as nvarchar(10)) as Fecha_Ultima_Visita
		...
		left outer join codelist ubi on I.locat_snr = ubi.clist_snr and ubi.rec_stat=0 and ubi.status=1
