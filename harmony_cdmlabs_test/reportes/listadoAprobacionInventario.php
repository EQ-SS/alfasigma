<?php
	...
	$tam = array(100,350,100,200,250,150,150,100,150,450);
	...
	$qMedicos = "SELECT 
		...
		(CASE WHEN len(SPU.INFO_CHANGE)>0 THEN SPU.INFO_CHANGE ELSE '---' END) as Comentarios
