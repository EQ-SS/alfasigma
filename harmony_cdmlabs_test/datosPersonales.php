				...
				<ul class="nav nav-tabs m-l--5 m-r--5 tab-col-blue p-l-5 tabDatosPer" role="tablist"
					...
					<li role="presentation">
						<a id="aPerfilPersona5" href="#tabBancos" data-toggle="tab" class="show-tooltip">
							...
							<div class="divTooltip">Bancos</div>
							<span class="hidden-txt-tabs">Bancos</span>
						</a>
					</li>
					<li role="presentation">
					...
					<div id="tabPerfilP">
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 margin-0">
								...
								<!--<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Requiere Factura: </p><label
											id="lblDivMedico"></label>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Médico Galeno: </p><label
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								...
								<!--<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Segmentación Flonor: </p><label
											id="lblSegmentacionFlonor"></label>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<p class="font-bold col-indigo text-inline">Segmentación Zifros: </p><label
